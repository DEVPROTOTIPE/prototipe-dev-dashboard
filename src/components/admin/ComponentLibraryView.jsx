...
import {
  ...
  Clock, Filter, ChevronDown, ChevronUp, GitCompare, Box, Cpu, Diff, ArrowUpDown, Palette
} from 'lucide-react';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute z-50 w-full mt-1 bg-[var(--color-surface-3)]/95 backdrop-blur-md border border-[var(--color-border)] rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto custom-scrollbar ${dropdownClassName}`}
          >
            {options.map((option) => {
                          ...
                          <div className="flex items-center justify-between gap-3 bg-slate-950 px-3 py-2 border border-slate-800 rounded-lg">
                            <code className="font-mono text-[10px] text-slate-300 select-all overflow-x-auto whitespace-nowrap scrollbar-none">
                              {(() => {
                                ...
                                if (preflightResult?.suggestedPath) {
                                  ...
                                  rawPath = rawPath.replace(/\.(jsx|js|tsx|ts)$/, '');
                                  importPath = rawPath;
                                }
                            ...
                            <button
                              onClick={() => {
                                ...
                                const importText = `import ${compName} from '@/${importPath}';`;
