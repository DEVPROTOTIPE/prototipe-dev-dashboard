...
export default function modulo_agendamiento_barberiaSandbox() {
  ...
  return (
    <SandboxLayout
      title="Módulo de Agendamiento de Citas (Barbería) (modulo_agendamiento_barberia) (modulo_agendamiento_barberia)"
      ...
      <div className={`p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-center min-h-[220px]`}>
        <div className="text-center space-y-2">
          <p className="text-xs text-[var(--color-text-muted)] font-mono">
            [ Componente modulo_agendamiento_barberia Scaffolded ]
          </p>
