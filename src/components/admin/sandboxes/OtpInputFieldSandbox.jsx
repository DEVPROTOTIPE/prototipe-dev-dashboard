    ...
    <div className="flex justify-center gap-2.5 w-full max-w-xs mx-auto">
      {Array.from({ length }).map((_, idx) => (
        <input
          ...
          onPaste={handlePaste}
          className={`w-11 h-11 sm:w-12 sm:h-12 text-center text-sm font-black bg-[var(--color-surface)] border rounded-xl outline-none text-slate-100 transition-all focus:scale-105 ${
            otp[idx] ? 'border-indigo-500 ring-2 ring-indigo-500/10' : 'border-[var(--color-border)]'
