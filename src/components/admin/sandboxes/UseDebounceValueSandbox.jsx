  ...
  return (
    ...
    >
      <div className="space-y-4 w-full">
        <div className="flex items-center gap-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-xl px-3.5 py-2.5">
        ...
        <div className="p-3 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-2 text-[10px] font-mono text-slate-300">
