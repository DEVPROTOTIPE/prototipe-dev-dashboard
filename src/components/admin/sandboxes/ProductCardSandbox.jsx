...
export default function ProductCardSandbox() {
  const [theme, setTheme] = useState('dark');

  return (
    <SandboxLayout
      title="Tarjeta de Producto Adaptativa y Skeleton Shimmer (ProductCard) (ProductCard)"
      ...
      <div className={`p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-center min-h-[220px]`}>
        <div className="text-center space-y-2">
          <p className="text-xs text-[var(--color-text-muted)] font-mono">
            [ Componente ProductCard Scaffolded ]
          </p>
