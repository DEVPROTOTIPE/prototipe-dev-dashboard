...
export default function propuesta_commits_desplieguesSandbox() {
  const [theme, setTheme] = useState('dark');

  return (
    <SandboxLayout
      title="Módulo de Control de Commits y Despliegues (propuesta_commits_despliegues) (propuesta_commits_despliegues)"
      ...
      <div className={`p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-center min-h-[220px]`}>
        <div className="text-center space-y-2">
          <p className="text-xs text-[var(--color-text-muted)] font-mono">
            [ Componente propuesta_commits_despliegues Scaffolded ]
          </p>
