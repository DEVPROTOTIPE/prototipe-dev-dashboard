...
export default function OrdenesTrabajoEquiposSandbox() {
  ...
  return (
    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 space-y-3 max-w-md mx-auto text-slate-200">
      <div>
      ...
      <div className="grid grid-cols-2 gap-2 text-[11px]">
        <input
          ...
          className="bg-slate-900 border border-slate-800 rounded-xl px-2.5 py-1.5 text-slate-200 focus:outline-none"
        />
        <input
          type="text"
          placeholder="Modelo..."
        ...
        <input
          ...
          className="bg-slate-900 border border-slate-800 rounded-xl px-2.5 py-1.5 text-slate-200 col-span-2 focus:outline-none"
        />
        <textarea
          placeholder="Fallo o diagnóstico..."
          value={equipment.description}
          onChange={e => setEquipment(prev => ({ ...prev, description: e.target.value }))}
          className="bg-slate-900 border border-slate-800 rounded-xl px-2.5 py-1.5 text-slate-200 col-span-2 focus:outline-none h-12 resize-none"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex gap-1.5 text-[11px]">
          <input
            ...
            className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-2.5 py-1 focus:outline-none"
          />
          <input
            type="number"
            placeholder="Precio..."
            ...
            className="w-16 bg-slate-900 border border-slate-800 rounded-xl px-2.5 py-1 focus:outline-none"
          />
          <button onClick={addPart} className="px-2 bg-indigo-600 rounded-xl font-bold cursor-pointer hover:bg-indigo-500">+</button>
        </div>

        {parts.length > 0 && (
          <div className="space-y-1 bg-slate-900/40 p-2 border border-slate-800 rounded-xl text-[9px] max-h-[80px] overflow-y-auto">
            {parts.map((part, idx) => (
      ...
      <div className="flex justify-between items-center text-xs">
        ...
        <input
          ...
          className="w-20 bg-slate-900 border border-slate-800 rounded-xl px-2 py-1 text-right font-mono focus:outline-none text-[11px]"
        />
      </div>
      ...
      <div className="space-y-1">
        ...
        <canvas
          ...
          className="w-full bg-slate-900 border border-dashed border-slate-800 rounded-xl cursor-crosshair h-16"
        />
      </div>
