...
function SandboxBentoCard({ title, description, icon, colSpan = 'sm:col-span-1', rowSpan = 'row-span-1', children, className = '', cta }) {
  return (
    <div className={`group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-[var(--color-surface)] border border-[var(--color-border)] p-4 transition-all duration-300 hover:scale-[1.01] hover:border-indigo-500/20 hover:shadow-xl ${colSpan} ${rowSpan} ${className}`}>
