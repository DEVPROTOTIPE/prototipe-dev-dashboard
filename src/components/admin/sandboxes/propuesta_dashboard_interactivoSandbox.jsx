...
export default function propuesta_dashboard_interactivoSandbox() {
  ...
  return (
    <SandboxLayout
      title="Propuesta Mini-Dashboard Interactivo (propuesta_dashboard_interactivo) (propuesta_dashboard_interactivo)"
      ...
      <div className={`p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-center min-h-[220px]`}>
        <div className="text-center space-y-2">
          <p className="text-xs text-[var(--color-text-muted)] font-mono">
            [ Componente propuesta_dashboard_interactivo Scaffolded ]
          </p>
