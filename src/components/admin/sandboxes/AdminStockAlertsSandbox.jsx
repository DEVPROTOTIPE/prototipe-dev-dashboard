...
export default function AdminStockAlertsSandbox() {
  const [theme, setTheme] = useState('dark');

  return (
    <SandboxLayout
      title="Widget de Reabastecimiento de Inventario Crítico (AdminStockAlerts) (AdminStockAlerts)"
      ...
      <div className={`p-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-center min-h-[220px]`}>
        <div className="text-center space-y-2">
          <p className="text-xs text-[var(--color-text-muted)] font-mono">
            [ Componente AdminStockAlerts Scaffolded ]
          </p>
