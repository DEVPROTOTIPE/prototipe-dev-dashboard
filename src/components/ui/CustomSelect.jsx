...
export default function CustomSelect({ value, onChange, options, placeholder = 'Seleccionar...', icon: Icon }) {
  ...
  return (
    <div ref={dropdownRef} className="relative w-full">
      ...
      {isOpen && options.length > 0 && (
        <div className="absolute top-full left-0 right-0 mt-1.5 z-50 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl shadow-xl shadow-black/30 max-h-48 overflow-y-auto backdrop-blur-md animate-scale-up origin-top">
          {options.map(o => {
