...
const MOCK_CATALOG = {
  retail_clothing: [
    { id: 'c1', name: 'Camiseta Oversize Algod├│n', price: 59900, emoji: '­ƒæò' },
    { id: 'c2', name: 'Jeans Slim Fit Denim', price: 120000, emoji: '­ƒæû' },
    { id: 'c3', name: 'Chaqueta Impermeable Acolchada', price: 180000, emoji: '­ƒºÑ' }
  ],
  technical_services: [
    { id: 't1', name: 'Mecanizado de Eje Rotatorio', price: 350000, emoji: 'ÔÜÖ´©Å' },
    { id: 't2', name: 'Fabricaci├│n de Buje de Bronce', price: 85000, emoji: '­ƒö®' },
    { id: 't3', name: 'Rectificaci├│n de Volante de Motor', price: 120000, emoji: '­ƒÜù' }
  ],
  refrigeration_ac: [
    { id: 'r1', name: 'Mantenimiento Preventivo Split', price: 95000, emoji: 'ÔØä´©Å' },
    { id: 'r2', name: 'Instalaci├│n de Aire Acondicionado', price: 320000, emoji: '­ƒî¼´©Å' },
    { id: 'r3', name: 'Recarga de Gas Refrigerante R410a', price: 140000, emoji: '­ƒº¬' }
  ],
  contractors: [
    { id: 'ct1', name: 'Instalaci├│n Drywall (m2)', price: 45000, emoji: '­ƒôÉ' },
    { id: 'ct2', name: 'Pintura de Fachada Exterior', price: 280000, emoji: '­ƒÄ¿' },
    { id: 'ct3', name: 'Enchape Cer├ímico Ba├▒o/Cocina', price: 60000, emoji: '­ƒº▒' }
  ],
  machinery_rental: [
    { id: 'm1', name: 'Alquiler Mini-Excavadora (D├¡a)', price: 450000, emoji: '­ƒÜ£' },
    { id: 'm2', name: 'Alquiler Planta El├®ctrica 5kW', price: 150000, emoji: 'ÔÜí' },
    { id: 'm3', name: 'Alquiler Mezcladora Concreto', price: 80000, emoji: '­ƒîÇ' }
  ],
  carpentry: [
    { id: 'cp1', name: 'Fabricaci├│n de Closet (m2)', price: 250000, emoji: '­ƒ¬Ü' },
    { id: 'cp2', name: 'Restauraci├│n de Puerta Madera', price: 110000, emoji: '­ƒÜ¬' },
    { id: 'cp3', name: 'Mesa de Centro Madera Maciza', price: 190000, emoji: '­ƒ¬Á' }
  ],
  laundry: [
    { id: 'l1', name: 'Lavado/Secado Edred├│n Plumas', price: 28000, emoji: '­ƒº║' },
    { id: 'l2', name: 'Lavado/Aplanchado Traje Formal', price: 22000, emoji: '­ƒæö' },
    { id: 'l3', name: 'Tintura de Prenda Algod├│n', price: 18000, emoji: '­ƒÄ¿' }
  ],
  furniture_repair: [
    { id: 'f1', name: 'Tapizado de Sof├í 3 Puestos', price: 680000, emoji: '­ƒøï´©Å' },
    { id: 'f2', name: 'Restauraci├│n Barniz Silla', price: 75000, emoji: '­ƒ¬æ' },
    { id: 'f3', name: 'Reparaci├│n Rieles de Cajonera', price: 45000, emoji: '­ƒöº' }
  ],
  wellness_podology: [
    { id: 'w1', name: 'Perfilaxis Podol├│gica Completa', price: 90000, emoji: '­ƒªÂ' },
    { id: 'w2', name: 'Tratamiento Onicomicosis (L├íser)', price: 120000, emoji: '­ƒöª' },
    { id: 'w3', name: 'Masaje Relajante Espalda/Cuello', price: 75000, emoji: '­ƒÆå' }
  ],
  grocery_food: [
    { id: 'g1', name: 'Canasta de Verduras Org├ínicas', price: 35000, emoji: '­ƒìÄ' },
    { id: 'g2', name: 'Caf├® Tostado Especial (500g)', price: 24000, emoji: 'Ôÿò' },
    { id: 'g3', name: 'Aceite de Oliva Extra Virgen', price: 42000, emoji: '­ƒ½Æ' }
  ]
};
...
const AVAILABLE_FONTS = [
  // Sans-Serif
  { value: 'Inter', desc: 'Sans-serif funcional y altamente legible a cualquier tama├▒o.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Poppins', desc: 'Redondeada premium, excelente para interfaces amigables.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Roboto', desc: 'Cl├ísica, limpia, geom├®trica y balanceada.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Montserrat', desc: 'Geom├®trica moderna, ideal para t├¡tulos impactantes.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Outfit', desc: 'Moderna, estilizada y con personalidad geom├®trica.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Plus Jakarta Sans', desc: 'Limpia, elegante y de estilo de negocio moderno.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Manrope', desc: 'Grotesque contempor├ínea de proporciones balanceadas.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'DM Sans', desc: 'Limpia, neutra y de baja distracci├│n visual.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Open Sans', desc: 'Altamente legible, neutral y de gran versatilidad.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Lato', desc: 'C├ílida, legible y muy popular en sitios web modernos.', cat: 'sans-serif', label: 'Sans-Serif' },
  ...
  { value: 'Work Sans', desc: 'Optimizada para pantallas de alta resoluci├│n.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Urbanist', desc: 'Estilo sans-serif geom├®trico elegante y sofisticado.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Lexend', desc: 'Dise├▒ada espec├¡ficamente para mejorar la velocidad de lectura.', cat: 'sans-serif', label: 'Sans-Serif' },
  ...
  { value: 'Quicksand', desc: 'Geometr├¡a puramente redondeada, juguetona y muy legible.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Fira Sans', desc: 'Dise├▒o abierto y org├ínico creado por Mozilla.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Kanit', desc: 'Formal, moderna y con gran variedad de pesos tipogr├íficos.', cat: 'sans-serif', label: 'Sans-Serif' },
  { value: 'Ubuntu', desc: 'Personalidad ├║nica con curvas fluidas e identidad tecnol├│gica.', cat: 'sans-serif', label: 'Sans-Serif' },

  // Serif
  { value: 'Playfair Display', desc: 'Serif elegante con alto contraste de trazos y mucha clase.', cat: 'serif', label: 'Serif' },
  { value: 'Lora', desc: 'Serif contempor├ínea con pinceladas suaves y tradicionales.', cat: 'serif', label: 'Serif' },
  { value: 'Merriweather', desc: 'Dise├▒ada espec├¡ficamente para lectura c├│moda en pantallas.', cat: 'serif', label: 'Serif' },
  { value: 'PT Serif', desc: 'Estilo cl├ísico con proporciones amplias y excelente legibilidad.', cat: 'serif', label: 'Serif' },
  { value: 'EB Garamond', desc: 'Cl├ísica renacentista, elegante, sofisticada y tradicional.', cat: 'serif', label: 'Serif' },
  { value: 'Cinzel', desc: 'Basada en inscripciones romanas cl├ísicas, ideal para lujo.', cat: 'serif', label: 'Serif' },
  { value: 'Cormorant Garamond', desc: 'Trazo fino de alto impacto editorial y gran distinci├│n.', cat: 'serif', label: 'Serif' },
  { value: 'Arvo', desc: 'Slab-serif geom├®trica robusta y de gran presencia visual.', cat: 'serif', label: 'Serif' },
  { value: 'Libre Baskerville', desc: 'Cl├ísica optimizada para bloques largos de texto.', cat: 'serif', label: 'Serif' },
  { value: 'Domine', desc: 'Serif amigable dise├▒ada para editoriales web.', cat: 'serif', label: 'Serif' },
  { value: 'DM Serif Display', desc: 'Contraste dram├ítico y sofisticado para grandes titulares.', cat: 'serif', label: 'Serif' },
  { value: 'Cardo', desc: 'Estilo de manuscrito medieval, cl├ísica y distinguida.', cat: 'serif', label: 'Serif' },

  // Display
  { value: 'Space Grotesk', desc: 'Brutalista y futurista, con caracteres de gran impacto.', cat: 'display', label: 'Display' },
  { value: 'Syne', desc: 'Art├¡stica, expresiva y dise├▒ada para marcas de moda o creativas.', cat: 'display', label: 'Display' },
  { value: 'Righteous', desc: 'Inspiraci├│n Art Deco con formas geom├®tricas singulares.', cat: 'display', label: 'Display' },
  { value: 'Syncopate', desc: 'Ancha, moderna y de proporciones muy extendidas para logos.', cat: 'display', label: 'Display' },
  { value: 'Cabinet Grotesk', desc: 'Formas contrastadas que llaman fuertemente la atenci├│n.', cat: 'display', label: 'Display' },
  { value: 'Unbounded', desc: 'Ancha, brutalista y de estilo cyber-tecnol├│gico.', cat: 'display', label: 'Display' },
  { value: 'Archivo Black', desc: 'Ultra-gruesa, id├│nea para t├¡tulos de gran tama├▒o e impacto.', cat: 'display', label: 'Display' },
  { value: 'Oswald', desc: 'Estilo condensado de gran altura para encabezados firmes.', cat: 'display', label: 'Display' },
  { value: 'Anton', desc: 'Dise├▒o ultra-bold de gran masa visual y estilo p├│ster.', cat: 'display', label: 'Display' },
  ...
  { value: 'Bungee', desc: 'Estilo urbano monol├¡tico inspirado en carteles callejeros.', cat: 'display', label: 'Display' },
  { value: 'Fredoka', desc: 'Dise├▒o amigable de puntas redondeadas e impacto blando.', cat: 'display', label: 'Display' },

  // Monospace
  { value: 'Space Mono', desc: 'Monospaciada tech con tintes retro y brutalistas.', cat: 'monospace', label: 'Monospace' },
  { value: 'Fira Code', desc: 'Dise├▒ada para desarrollo con ligaduras de programaci├│n.', cat: 'monospace', label: 'Monospace' },
  { value: 'JetBrains Mono', desc: 'Optimizada para m├íxima claridad de c├│digo y lectura t├®cnica.', cat: 'monospace', label: 'Monospace' },
  { value: 'Source Code Pro', desc: 'Monospaciada limpia y neutral de Adobe.', cat: 'monospace', label: 'Monospace' },
  { value: 'IBM Plex Mono', desc: 'Basada en la ingenier├¡a cl├ísica de IBM.', cat: 'monospace', label: 'Monospace' },
  { value: 'Inconsolata', desc: 'Sublime tipograf├¡a mono muy cercana al cl├ísico Consolas.', cat: 'monospace', label: 'Monospace' },
  { value: 'Courier Prime', desc: 'Remasterizaci├│n del estilo de m├íquina de escribir cl├ísica.', cat: 'monospace', label: 'Monospace' },
  ...
  { value: 'Anonymous Pro', desc: 'Dise├▒ada para programadores, con caracteres muy legibles.', cat: 'monospace', label: 'Monospace' },

  // Handwriting/Script
  { value: 'Great Vibes', desc: 'Caligraf├¡a cursiva cl├ísica con trazos largos y elegantes.', cat: 'handwriting', label: 'Script' },
  { value: 'Caveat', desc: 'Tipograf├¡a de escritura a mano fluida y muy natural.', cat: 'handwriting', label: 'Script' },
  { value: 'Pacifico', desc: 'Cursiva retro inspirada en la cultura surf norteamericana.', cat: 'handwriting', label: 'Script' },
  { value: 'Dancing Script', desc: 'Cursiva informal y din├ímica con trazos org├ínicos.', cat: 'handwriting', label: 'Script' },
  { value: 'Sacramento', desc: 'L├¡nea fina y trazos continuos, elegante y sofisticada.', cat: 'handwriting', label: 'Script' },
  { value: 'Satisfy', desc: 'Brush script contempor├ínea de curvas fluidas e informales.', cat: 'handwriting', label: 'Script' },
  { value: 'Yellowtail', desc: 'Pincelada plana con toques vintage muy amigables.', cat: 'handwriting', label: 'Script' },
  { value: 'Alex Brush', desc: 'Caligraf├¡a fluida con trazos elegantes de altura corta.', cat: 'handwriting', label: 'Script' },
  { value: 'Allura', desc: 'Estilo manuscrito de trazos finos y sumamente aireados.', cat: 'handwriting', label: 'Script' },
  { value: 'Pinyon Script', desc: 'Cursiva ultra-inclinada aristocr├ítica y de gran lujo.', cat: 'handwriting', label: 'Script' }
];
...
function InteractiveAmbientGlow({
  ...
  return (
    ...
    >
      {/* Blob 1 ÔÇö primary, arriba-izquierda */}
      <div 
        style={{
      ...
      {/* Blob 2 ÔÇö accent, abajo-derecha */}
      <div 
        style={{
      ...
      {/* Blob 4 ÔÇö accent secundario, arriba-derecha */}
      <div 
        style={{
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* === MORPH KEYFRAMES ÔÇö formas org├ínicas irregulares === */
...
// ÔöÇÔöÇÔöÇ Custom Cursor (solo desktop) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
// Dot SVG renderizado a nivel OS (cero latencia JS) ÔÇö 4 4 = hotspot centrado
...
function getContrastFeedback(ratio) {
  ...
  if (ratio >= 4.5) return { text: 'AA (├ôptimo)', badgeClass: 'bg-emerald-500/10 border border-emerald-500/20 text-emerald-400', isPass: true };
...
const PALETTE_CATEGORIES = [
  {
    id: "retail_clothing",
    name: "­ƒøì´©Å Ropa y Retail Tradicional",
    palettes: [
  ...
  },
  {
    ...
    name: "ÔÜÖ´©Å Torner├¡as y Mecanizado de Precisi├│n",
    palettes: [
  ...
  {
    id: "refrigeration_ac",
    name: "ÔØä´©Å Refrigeraci├│n y Climatizaci├│n",
    palettes: [
  ...
  {
    id: "contractors",
    name: "­ƒôÉ Contratistas y Construcci├│n",
    palettes: [
  ...
  {
    id: "machinery_rental",
    name: "­ƒÜ£ Alquiler de Maquinaria y Equipos",
    palettes: [
  ...
  {
    id: "carpentry",
    name: "­ƒ¬Ü Carpinter├¡as y Muebles",
    palettes: [
  ...
  {
    id: "laundry",
    name: "­ƒº║ Lavander├¡as y Tintorer├¡as",
    palettes: [
  ...
  {
    id: "furniture_repair",
    name: "­ƒøï´©Å Restauraci├│n y Tapicer├¡a de Muebles",
    palettes: [
  ...
  },
  {
    ...
    name: "­ƒÆå Est├®tica, Podolog├¡a y Bienestar",
    palettes: [
  ...
  {
    id: "grocery_food",
    name: "­ƒìÄ Minimarkets y Alimentos",
    palettes: [
...
export default function App() {
  ...
  // Estados de edici├│n para CRM de clientes
  ...
  // Estados de edici├│n de Alerta Remota del Sistema (sistemaAlerta)
  ...
  const [mockOrders, setMockOrders] = useState([
    ...
    { id: 2, title: 'Servicio T├®cnico Calzado', time: 'Hace 2 horas', val: 150000 },
  ...
  // Carga reactiva de fragmento de c├│digo para diagn├│stico de errores
  useEffect(() => {
    ...
    if (!file || file === 'N/A') {
      setCodeSnippet(null);
      setCodeError('No se pudo identificar una ruta de archivo v├ílida en el error.');
      return;
    }
    ...
    fetch(`${CLI_URL}/api/project/file?clientId=${encodeURIComponent(selectedDiagnosticError.clientId)}&relativePath=${encodeURIComponent(file)}`)
      .then(res => {
        if (!res.ok) throw new Error('El archivo no est├í accesible en el servidor local o la CLI Bridge no est├í corriendo.');
        return res.json();
      })
      .then(data => {
        if (data.success) {
      ...
      .catch(err => {
        console.error('Error al cargar fragmento de c├│digo:', err);
  ...
  // Estados de carga, b├║squeda y UI general
  ...
  // --- MODAL DE SIMULACI├ôN DE FALLOS AVANZADO ---
  ...
  const [waTemplates, setWaTemplates] = useState([
    {
      ...
      body: 'Hola *{cliente}*, te informamos que la comisi├│n del periodo *{periodo}* por valor de *${comision}* est├í pendiente. ┬íGracias por tu atenci├│n!'
    },
    {
      id: 'recordatorio-urgente',
      name: 'Recordatorio Urgente',
      body: 'ÔÜá´©Å *{cliente}*, tu saldo de comisi├│n del mes *{periodo}* por *${comision}* a├║n no ha sido recibido. Por favor regulariza para evitar inconvenientes con el servicio.'
    },
    {
      id: 'confirmacion-pago',
      name: 'Confirmaci├│n de Pago Recibido',
      body: 'Ô£à Hola *{cliente}*, confirmamos recibo del pago de comisi├│n correspondiente al periodo *{periodo}* por *${comision}*. ┬íMuchas gracias!'
    }
  ])
  ...
  // Listado unificado de clientes que env├¡an telemetr├¡a
  ...
  // Filtrado avanzado de logs de la consola de telemetr├¡a
  const filteredTelemetryLogs = useMemo(() => {
    return systemLogs.filter(log => {
      ...
      if (telemetryTypeFilter === 'error') {
        ...
        matchesType = log.type === 'success' && (log.message.includes('facturaci├│n') || log.message.includes('cobro') || log.message.includes('Billing') || log.message.includes('reportes'));
      } else if (telemetryTypeFilter === 'info_warning') {
        matchesType = log.type === 'info' || log.type === 'warning';
      }
      
      // Filtro por caja de b├║squeda de texto
  ...
  // Cargar plantillas din├ímicamente y cat├ílogo de la biblioteca
  ...
  useEffect(() => {
    ...
    // 2. Cargar cat├ílogo de biblioteca para recomendaciones
    fetch(`${CLI_URL}/api/library`)
      ...
      .catch(err => console.warn("No se pudo cargar cat├ílogo de la biblioteca para recomendaciones:", err))
  }, [])
    ...
    reader.onload = async (event) => {
      ...
      try {
        ...
        if (data.success) {
          ...
          addLog(`Logo procesado con ├®xito en el servidor. Ruta f├¡sica: ${data.filePath}`, "info")
        } else {
  ...
  const validateFirebaseCreds = async () => {
    ...
    try {
      ...
      if (data.valid) {
        ...
        showToast(data.warning || 'Credenciales de Firebase validadas con ├®xito.', { type: 'success' })
      } else {
  ...
  const handleAutoDetectConfig = async () => {
    ...
    try {
      ...
      addLog(`Ô£ô Credenciales Firebase auto-detectadas y cargadas para ${cleanProjectId}.`, 'success')
      showToast('Configuraci├│n de Firebase auto-detectada y rellenada Ô£ô', { type: 'success' })
    } catch (err) {
  ...
  // Reintentar solo el aprovisionamiento f├¡sico en disco (CLI) cuando Firestore ya fue exitoso
  const handleRetryCliProvisioning = async () => {
    ...
    try {
      ...
      if (cliRes.ok) {
        ...
        showToast(`Reintento exitoso ÔÇö ${nombre} aprovisionado en disco Ô£ô`, { type: 'success' })
        ...
        addLog(`[Reintento fallido] CLI respondi├│ con error: ${errMessage}`, 'error')
        showToast(`Sigue fallando: ${errMessage}`, { type: 'error' })
      }
    } catch (retryErr) {
      addLog(`[Reintento fallido] Daemon CLI sigue offline o hay error de conexi├│n: ${retryErr.message}`, 'error')
  ...
  // Descartar aprovisionamiento pendiente elimin├índolo f├¡sicamente de Firestore Central
  const handleDiscardPendingProvisioning = async () => {
    ...
    const confirmed = await showConfirm({
      ...
      message: `┬┐Est├ís seguro de que deseas descartar y eliminar el registro de ${nombre} de Firestore central?`,
    ...
    if (isSimulated) {
      ...
      showToast('Registro de cliente descartado (Sandbox) Ô£ô', { type: 'success' })
      return
    }
    ...
    try {
      ...
      addLog(`[Firestore] Registro de cliente ${clientId} y su token ${telemetryToken} eliminados con ├®xito.`, "success")
      setPendingCliProvisioning(null)
  ...
  const addLog = (message, type = 'info', client = null) => {
    ...
    setLogPage(1) // Reset a la primera p├ígina para ver el nuevo log
  }
  ...
  useEffect(() => {
    ...
    const handleOnline = () => {
      setIsOnline(true)
      addLog("Conexi├│n de red restablecida. Consola de telemetr├¡a en l├¡nea.", "success")
    }
    const handleOffline = () => {
      setIsOnline(false)
      addLog("Sin conexi├│n a internet. Operando en modo local/desconectado.", "error")
    }
  ...
  useEffect(() => {
    ...
    addLog("Iniciando conexi├│n con Consola Central...", "warning")
    const centralApp = getCentralApp()
    if (!centralApp) {
      loadSimulatedData()
      setIsSimulated(true)
    ...
    addLog("Conexi├│n con base de datos Firestore Central establecida.", "success")
    ...
    const unsubAuth = onAuthStateChanged(authInstance, (firebaseUser) => {
      ...
      if (firebaseUser) {
        addLog(`Sesi├│n iniciada como ${firebaseUser.email}`, "success")
        ...
        try {
          ...
          unsubDocs = onSnapshot(q, (snapshot) => {
            ...
            snapshot.docChanges().forEach((change) => {
              if (change.type === "added") {
                ...
                addLog(`Reporte de facturaci├│n periodico [${docData.periodo}] registrado por valor de $${Number(docData.comisionValor || 0).toLocaleString()} (Ventas: $${Number(docData.totalVentas || 0).toLocaleString()}).`, "success", docData.clientId)
              }
            })
          }, (error) => {
            ...
            setIsLoading(false)
            addLog("Acceso denegado a Firestore. Cargando Sandbox local autom├ítico.", "error")
          })

          // Escuchar configuraci├│n de tasas comisiones de instancias
          ...
          // Escuchar tokens de telemetr├¡a en tiempo real
          ...
          unsubFailures = onSnapshot(qFailures, (snapshot) => {
            ...
            snapshot.docChanges().forEach((change) => {
              if (change.type === "added") {
                const docData = change.doc.data()
                addLog(`FALLO DETECTADO: "${docData.errorMsg || 'Error gen├®rico'}" en ruta ${docData.environment?.url || 'N/A'}.`, "error", docData.clientId)
              }
            })
          }, (error) => {
        ...
        setReports([])
        setIsLoading(false)
        addLog("Cerrando sesi├│n del desarrollador.", "info")
      }
    })
  ...
  const handleLogin = async (e) => {
    ...
    setAuthError('')
    setAuthLoading(true)
    addLog(`Intentando autenticaci├│n para ${email}...`, "info")
    ...
    if (!centralApp) {
      ...
      addLog("Sandbox Bypass: Sesi├│n simulada autorizada.", "success")
      return
    }
    ...
    try {
      ...
      console.error(err)
      setAuthError('Credenciales incorrectas o error de conexi├│n.')
      addLog("Error de inicio de sesi├│n: Credenciales inv├ílidas.", "error")
    } finally {
      setAuthLoading(false)
    }
  }
  ...
  const handleTogglePayment = async (report) => {
    ...
    const confirmed = await showConfirm({
      ...
      message: `┬┐Est├ís seguro de que deseas marcar el reporte de ${report.clientId} (${report.periodo}) como ${nuevoEstado.toUpperCase()}?`,
      confirmText: nuevoEstado === 'pagado' ? 'S├¡, Aprobar' : 'S├¡, Pendiente',
      cancelText: 'Cancelar',
    ...
    if (isSimulated) {
      ...
      // Actualizar inspector si est├í abierto
  ...
  const handleStartLocalServer = async (clientId) => {
    ...
    try {
      ...
      addLog(`[Local Server Error] Fall├│ al iniciar servidor local para ${clientId}: ${err.message}`, 'error');
  ...
  const handleStopLocalServer = async (clientId) => {
    ...
    try {
      ...
      addLog(`[Local Server Error] Fall├│ al detener servidor para ${clientId}: ${err.message}`, 'error');
      showToast(`Error al detener servidor para ${clientId}`, { type: 'error' });
    }
  };

  // --- FUNCIONES EXTRA E INTERACTIVIDAD DE AUTOMATIZACI├ôN ---
  ...
  const handleDeployFirebaseRules = async (clientId, type = 'all') => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        addLog(`[Firebase Rules] Reglas (${type}) desplegadas con ├®xito para ${clientId}. Output: ${data.output || ''}`, 'success');
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (data.type === 'log') {
          ...
          if (data.status === 'stopped' || data.status === 'success' || data.status === 'error') {
            ...
            if (isNpm) {
              addLog(`[Dependencias] Instalaci├│n en ${terminalDrawer.clientId} finalizada: ${data.message || ''}`, data.status === 'success' ? 'success' : 'error');
              fetchGlobalDrift();
            }
          }
        }
    ...
    eventSource.onerror = (err) => {
      ...
      setTerminalLogs(prev => [...prev, "[SISTEMA ERROR] Conexi├│n SSE cerrada o proceso terminado."]);
      eventSource.close();
    };
  ...
  const handleGitDiscard = async (clientId, file, discardAll = false) => {
    const confirmMsg = discardAll 
      ? '┬┐Est├ís seguro de que deseas descartar TODOS los cambios locales de este repositorio? Esta acci├│n no se puede deshacer.'
      : `┬┐Est├ís seguro de que deseas descartar los cambios locales del archivo "${file}"?`;
  ...
  // Solicitar telemetr├¡a de un cliente espec├¡fico
  const handleRequestClientTelemetry = async (clientId) => {
    addLog(`Solicitando reporte de telemetr├¡a a ${clientId}...`, "info")
    
    if (isSimulated) {
      addLog(`[Sandbox] Telemetr├¡a solicitada para ${clientId}. (Simulado)`, "success")
      showToast(`[Sandbox] Telemetr├¡a solicitada para ${clientId}`, { type: 'success' })
      return
    }

    const centralApp = getCentralApp()
    if (!centralApp) {
      addLog("Error: No se pudo inicializar la aplicaci├│n central.", "error")
      return
    }
    const dbInstance = getFirestore(centralApp)
    ...
    try {
      ...
      addLog(`[Firestore] Telemetr├¡a solicitada exitosamente para ${clientId}.`, "success")
      showToast(`Telemetr├¡a solicitada para ${clientId}`, { type: 'success' })
    } catch (err) {
      console.error("Error solicitando telemetr├¡a:", err)
      addLog(`Error al solicitar telemetr├¡a para ${clientId}: ${err.message}`, "error")
      showToast(`Error al solicitar telemetr├¡a: ${err.message}`, { type: 'error' })
    }
  }

  // Solicitar telemetr├¡a de todos los clientes a nivel global (Abre modal de personalizaci├│n)
  const handleRequestAllTelemetry = () => {
    const active = clientesSaas.filter(c => !c.archived);
    if (active.length === 0) {
      showToast("No hay clientes activos para solicitar telemetr├¡a", { type: 'error' });
      return;
    }
  ...
  const handleExecuteGlobalTelemetry = async () => {
    ...
    if (selectedIds.length === 0) {
      showToast("Debe seleccionar al menos un cliente para solicitar telemetr├¡a", { type: 'error' });
      return;
    }

    setIsGlobalTelemetryModalOpen(false);
    addLog(`Solicitando reporte de telemetr├¡a para ${selectedIds.length} clientes...`, "info");
    
    if (isSimulated) {
      addLog(`[Sandbox] Telemetr├¡a global solicitada para: ${selectedIds.join(', ')}. (Simulado)`, "success");
      showToast(`[Sandbox] Telemetr├¡a global solicitada`, { type: 'success' });
      return;
    }
    ...
    try {
      ...
      addLog(`[Firestore] Telemetr├¡a solicitada para ${selectedIds.length} clientes: ${selectedIds.join(', ')}.`, "success");
      showToast(`Telemetr├¡a solicitada para ${selectedIds.length} clientes`, { type: 'success' });
    } catch (err) {
      console.error("Error solicitando telemetr├¡a global:", err);
      addLog(`Error al solicitar telemetr├¡a global: ${err.message}`, "error");
      showToast(`Error al solicitar telemetr├¡a global: ${err.message}`, { type: 'error' });
    }
  };


  // Guardar configuraci├│n modificada en CRM
  const handleSaveCrmConfig = async () => {
    if (!selectedCrmClientId) return;
    
    addLog(`Guardando configuraci├│n de vertical/cobro para cliente ${selectedCrmClientId}...`, "info")
    ...
    if (isSimulated) {
      ...
      addLog(`[Sandbox] Configuraci├│n de cliente ${selectedCrmClientId} actualizada localmente.`, "success")
      showToast('Configuraci├│n guardada (Modo Sandbox)', { type: 'success' })
    ...
    try {
      ...
      addLog(`[Firestore] Configuraci├│n de cliente ${selectedCrmClientId} guardada en Firestore central.`, "success")
      showToast('Configuraci├│n guardada correctamente', { type: 'success' })
      setActiveMetricModal(null)
      setSelectedCrmClientId(null)
    } catch (err) {
      console.error("Error al actualizar cliente:", err)
      addLog(`Error al guardar configuraci├│n de cliente: ${err.message}`, "error")
      showToast(`Error al guardar configuraci├│n: ${err.message}`, { type: 'error' })
    }
  }
  ...
  const loadDriftData = async (clientId) => {
    ...
    try {
      ...
      showToast(`Error al cargar desviaci├│n del Core: ${err.message}`, { type: 'error' })
    } finally {
  ...
  const handleBulkSync = async (clientId, selectedFiles) => {
    ...
    try {
      ...
      const data = await res.json()
      if (data.success) {
        showToast(`Sincronizados ${selectedFiles.length} archivos con ├®xito`, { type: 'success' })
      ...
      showToast(`Error en sincronizaci├│n masiva: ${err.message}`, { type: 'error' })
    } finally {
  ...
  const handleDeployClient = (clientId, force = false) => {
    ...
    eventSource.onmessage = (event) => {
      try {
        ...
        if (data.type === 'log') {
          ...
          if (data.line.includes('Compilando aplicaci├│n local')) {
            setDeployProgressPercent(25);
          } else if (data.line.includes('Compilaci├│n exitosa')) {
            setDeployProgressPercent(50);
          } else if (data.line.includes('auditor├¡a f├¡sica')) {
            setDeployProgressPercent(70);
          } else if (data.line.includes('Subiendo a Firebase Hosting')) {
            setDeployProgressPercent(85);
          } else if (data.line.includes('Despliegue completado con ├®xito')) {
          ...
          if (data.success) {
            setDeployState('success');
            setDeployProgressPercent(100);
            showToast(`┬íDespliegue exitoso para ${clientId}!`, { type: 'success' });
          } else {
          ...
          setDeployLogs(prev => [...prev, `ÔØî AUDITOR├ìA DE CALIDAD FALL├ô (Puntaje: ${data.score}/100)`]);
          showToast(`Despliegue cancelado por puntaje de auditor├¡a bajo: ${data.score}`, { type: 'error' });
          eventSource.close();
        }
      } catch (err) {
    ...
    eventSource.onerror = (err) => {
      ...
      setDeployState('failed');
      setDeployError("Conexi├│n interrumpida con el servidor de compilaci├│n");
      eventSource.close();
    };
  };
  ...
  const handleExecuteGlobalSync = async () => {
    ...
    addLog(`[Sincronizaci├│n Global] Iniciando an├ílisis y sincronizaci├│n para ${selectedIds.length} clientes...`, "info");
    showToast("Iniciando sincronizaci├│n...", { type: 'info' });
    let totalSynced = 0;
        ...
        if (drift.success && drift.differences.length > 0) {
          ...
          if (safeFiles.length > 0) {
            ...
            if (syncData.success) {
              ...
              addLog(`Ô£ö Sincronizaci├│n completa para ${clientId}.`, "success");
            }
          } else {
            addLog(`Sincronizaci├│n para ${clientId}: Sin archivos core pendientes de actualizar.`, "info");
          }
        } else {
          addLog(`Sincronizaci├│n para ${clientId}: Paridad total con el Core de referencia.`, "success");
        }
      } catch (err) {
        addLog(`ÔØî Error sincronizando ${clientId}: ${err.message}`, "error");
      }
    }
    ...
    if (totalSynced > 0) {
      showToast(`Sincronizaci├│n global completada: ${totalSynced} archivos seguros actualizados.`, { type: 'success' });
    } else {
      showToast("Sincronizaci├│n global terminada sin cambios pendientes.", { type: 'info' });
    }
  };
  ...
  const handleSimulateFailure = async (customParams = null) => {
    ...
    if (isSimulated) {
      ...
      try {
        ...
        addLog(`[TELEMETR├ìA] Registrado nuevo reporte de fallo de: ${newFailure.clientId} en Firestore Central`, 'error')
  ...
  const handleResolveFailure = async (idOrIds, note = '') => {
    ...
    if (isSimulated) {
      ...
      try {
        ...
        setFailures(prev => prev.map(f => ids.includes(f.id) ? { ...f, ...updateData } : f))
        addLog(`[TELEMETR├ìA] ${ids.length} fallo(s) marcado(s) como resuelto(s) en Firestore.`, 'success')
  ...
  const handleResolveAllFailures = async () => {
    ...
    if (isSimulated) {
      ...
      try {
        ...
        await Promise.all(batchPromises)
        addLog(`[TELEMETR├ìA] ${activeFailures.length} fallos marcados como resueltos en Firestore.`, 'success')
  ...
  const handleClearAllFailures = async () => {
    ...
    const confirm = await showAlert({
      ...
      message: `Esta acci├│n eliminar├í de forma permanente los ${failures.length} incidentes del historial. No se puede deshacer.`,
      variant: 'danger',
    ...
    if (isSimulated) {
      ...
      try {
        ...
        await Promise.all(batchPromises)
        setErrorsPage(1)
        addLog(`[TELEMETR├ìA] ${failures.length} incidentes eliminados f├¡sicamente de la colecci├│n 'app_failures'.`, 'success')
  ...
  const handleCreateTestReport = async () => {
    ...
    addLog(`Generando telemetr├¡a de prueba para ${targetClient} ($${sales.toLocaleString()} Ventas, ${pct}%)`, "info", targetClient)
    ...
    try {
      ...
      addLog(`[Firestore] Telemetr├¡a enviada con ├®xito a la nube central.`, "success", targetClient)
    } catch (err) {
      console.error(err)
      addLog(`Error al enviar telemetr├¡a: ${err.message}`, "error")
    }
  }
  ...
  // Clientes ordenados por mayor comisi├│n acumulada para el gr├ífico
  ...
  // Datos formateados para el Gr├ífico General Consolidado
  ...
  // Obtiene historial mensual detallado de un cliente espec├¡fico
  ...
  const getPeriodLabel = (periodStr) => {
    if (!periodStr) return 'Hist├│rico Completo'
    const parts = periodStr.split('-')
    if (parts.length !== 2) return periodStr
    const [y, m] = parts
    const monthsFull = [
  ...
  const projExistingMonthly = useMemo(() => {
    return clientesSaas.reduce((sum, c) => {
      ...
      if (mode === 'percentage') {
        ...
        // Asumir un promedio est├índar de 12 transacciones/servicios al mes
  ...
  // Datos para gr├íficos de BI y m├írgenes netos
  ...
  if (!user) {
    return (
      <div className="min-h-screen relative flex items-center justify-center bg-[var(--color-bg)] px-4 font-sans overflow-hidden transition-colors duration-300">
        {/* ÔöÇÔöÇ Fondo tecnol├│gico premium ÔöÇÔöÇ */}
        ...
        >
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[var(--color-text)]">Correo Electr├│nico</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-[var(--color-text)]">Contrase├▒a</label>
              <div className="relative">
                <input 
  ...
  if (isOnboardingActive) {
    return (
      <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-sans pb-12 overflow-x-clip transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="space-y-4 min-h-[350px]">
                {wizardTab === 'server' && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-[var(--color-text-muted)] block">Modelo de Facturaci├│n</label>
                        <CustomSelect 
                          value={billingMode}
                      ...
                      {billingMode === 'percentage' && (
                        <div className="space-y-1 animate-fade-in">
                          <label className="text-[10px] font-bold text-[var(--color-text-muted)] block">Tasa de Comisi├│n (%)</label>
                          <input 
                            type="number" 
                            step="0.1"
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-[var(--color-text-muted)] block">Ruta F├¡sica en Disco</label>
                        <input 
                          type="text" 
                          value={targetPath}
                    ...
                    <div className="border-t border-[var(--color-border)] pt-4 mt-2 space-y-4">
                      {/* Toggle de Aprovisionamiento Autom├ítico */}
                      <div className="flex items-center justify-between p-3.5 bg-indigo-600/10 border border-indigo-500/25 rounded-2xl">
                        <div className="space-y-0.5 max-w-[80%]">
                          <label className="text-xs font-bold text-[var(--color-text)] block">Aprovisionar Firebase Autom├íticamente</label>
                          <span className="text-[10px] text-[var(--color-text-muted)] leading-relaxed block">
                            Habilita la creaci├│n desatendida del proyecto, base de datos Firestore y registro de la Web App bajo tus credenciales de CLI.
                          </span>
                        </div>
                        <button
                          type="button"
                      ...
                      {autoProvisionFirebase ? (
                        <div className="p-4 bg-emerald-500/10 border border-emerald-500/25 rounded-2xl space-y-2.5 animate-fade-in">
                          <span className="text-[10px] uppercase font-bold text-emerald-400 tracking-wider block">Plan de Aprovisionamiento Autom├ítico</span>
                          <p className="text-xs text-[var(--color-text-muted)] leading-relaxed">
                            El daemon CLI local crear├í el proyecto Firebase con el identificador recomendado:
                          </p>
                          ...
                          <p className="text-[10px] text-[var(--color-text-muted)] italic">
                            Ô£ô Firestore, Web Auth, y la Web App se inicializar├ín autom├íticamente. Las credenciales se extraer├ín e inyectar├ín directamente.
                          </p>
                        </div>
                      ) : (
                        <div className="space-y-4 animate-fade-in">
                                ...
                                onClick={async () => {
                                  try {
                                    ...
                                    if (data.publicKey) {
                                      ...
                                      showToast('Clave VAPID generada Ô£ô', { type: 'success' });
                                    } else {
                          ...
                          <div className="flex items-center gap-3 p-3 bg-indigo-500/5 border border-indigo-500/15 rounded-xl justify-between">
                            ...
                            >
                              {isValidatingCredentials ? 'Validando...' : 'Comprobar Conexi├│n'}
                            </button>
                          </div>

                          {credentialsValidationError && (
                            <div className="p-3 bg-rose-500/10 border border-rose-500/25 rounded-xl">
                              <p className="text-[10px] text-rose-400 font-bold leading-relaxed">ÔÜá´©Å {credentialsValidationError}</p>
                            </div>
                          )}
                          ...
                          {isCredentialsValidated && !credentialsValidationError && (
                            <div className="p-2.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center gap-1.5 animate-fade-in">
                              <span className="text-[9px] text-emerald-400 font-bold">­ƒƒó Conexi├│n validada con ├®xito. Credenciales listas y autorizadas.</span>
                            </div>
                          )}
                          ...
                          {!isCredentialsValidated && !credentialsValidationError && fbApiKey.trim() && fbProjectId.trim() && !isValidatingCredentials && (
                            <div className="p-2.5 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center gap-1.5 animate-fade-in">
                              <span className="text-[9px] text-amber-400 font-bold">­ƒƒí Credenciales listas para comprobar (presiona "Comprobar Conexi├│n").</span>
                            </div>
                          )}
                        </div>
                      )}
                ...
                {wizardTab === 'branding' && (
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start animate-fade-in">
                    {/* Columna Izquierda: Configuraci├│n de Marca y Colores (lg:col-span-7) */}
                    <div className="lg:col-span-7 space-y-6">
                      {/* Paletas de Colores Preestablecidas (Por Categor├¡as de Nicho) */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="relative group flex flex-col items-center justify-center border-2 border-dashed border-[var(--color-border)] hover:border-indigo-500/50 rounded-xl p-4 transition-all bg-[var(--color-bg)]/40 hover:bg-[var(--color-bg)]/70 text-center cursor-pointer">
                              ...
                              <span className="text-[8px] text-[var(--color-text-muted)] mt-0.5">Si supera los 2MB, se auto-optimizar├í a 512px.</span>
                            </div>
                          </div>
                          ...
                          <div className="space-y-2.5">
                            ...
                            {logoLocalPath && (
                              <div className="p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-between">
                                ...
                                <span className="text-[9px] text-emerald-400 font-bold">Ô£ô Listo</span>
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        {/* Bot├│n para abrir Personalizaci├│n Avanzada */}
                        <div className="space-y-2 sm:col-span-2 p-3 bg-[var(--color-surface-2)]/25 border border-[var(--color-border)] rounded-2xl">
                          ...
                          >
                            <span className="flex items-center gap-1.5">
                              ­ƒÄ¿ {showAdvancedColors ? 'Ocultar' : 'Mostrar'} Personalizaci├│n de Colores Avanzada (Tokens HSL)
                            </span>
                            <span>{showAdvancedColors ? 'Ôû▓' : 'Ôû╝'}</span>
                          </button>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 pt-3 border-t border-[var(--color-border)] animate-fade-in">
                              ...
                              <div className="space-y-1 sm:col-span-2">
                                ...
                                >
                                  ...
                                  <option value="0.5rem">Est├índar (8px)</option>
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-24 space-y-6">
                      ...
                      <div className="p-4 bg-slate-500/5 dark:bg-slate-900/40 border border-[var(--color-border)] rounded-2xl space-y-4">
                        ...
                        >
                          ...
                          <div className="p-3.5 space-y-3.5">
                            {/* Saludo y Categor├¡a */}
                            <div className="space-y-0.5">
                              <span className="text-[8px] font-bold tracking-wide uppercase opacity-50">Explorar cat├ílogo</span>
                            ...
                            >
                              ...
                              >
                                <span className="text-[16px]">­ƒøì´©Å</span>
                                <span 
                              ...
                              <div className="space-y-1">
                                ...
                                <p className="text-[8px] leading-relaxed" style={{ color: textMutedColor }}>
                                  Dise├▒o exclusivo de alta costura, materiales sostenibles y confort total para el d├¡a a d├¡a.
                                </p>
                              </div>

                              {/* Botones de Acci├│n de Tarjeta */}
                            ...
                            >
                              <div className="space-y-0.5">
                                <span className="text-[8.5px] font-bold block leading-none">Env├¡o Gratis Garantizado</span>
                                <span className="text-[7.5px] block opacity-60" style={{ color: textMutedColor }}>Por compras superiores a $150k</span>
                              </div>
                              <span className="text-xs">­ƒÜÜ</span>
                            </div>
                          </div>
                        </div>
                      </div>

                      {/* Secci├│n de Validaci├│n de Accesibilidad WCAG 2.1 */}
                      <div className="p-4 bg-slate-500/5 dark:bg-slate-900/40 border border-[var(--color-border)] rounded-2xl space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[9px] font-bold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 rounded-full px-2 py-0.5">Est├índar W3C</span>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {/* Contraste Bot├│n Primario */}
                          {(() => {
                            ...
                            return (
                              <div className="p-3 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-2 flex flex-col justify-between">
                                <div>
                                  <span className="text-[9px] font-bold text-[var(--color-text-muted)] uppercase block">Contraste del Bot├│n Primario</span>
                    ...
                    <div className="p-4 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-2xl space-y-4">
                      <div className="space-y-1.5 border-b border-[var(--color-border)] pb-4">
                        ...
                        <CustomSelect 
                          ...
                          options={[
                            { id: "retail_clothing", name: "­ƒøì´©Å Ropa y Retail Tradicional (retail_clothing)" },
                            { id: "technical_services", name: "ÔÜÖ´©Å Torner├¡as y Mecanizado de Precisi├│n (technical_services)" },
                            { id: "refrigeration_ac", name: "ÔØä´©Å Refrigeraci├│n y Climatizaci├│n (refrigeration_ac)" },
                            { id: "contractors", name: "­ƒôÉ Contratistas y Construcci├│n (contractors)" },
                            { id: "machinery_rental", name: "­ƒÜ£ Alquiler de Maquinaria y Equipos (machinery_rental)" },
                            { id: "carpentry", name: "­ƒ¬Ü Carpinter├¡as y Muebles (carpentry)" },
                            { id: "laundry", name: "­ƒº║ Lavander├¡as y Tintorer├¡as (laundry)" },
                            { id: "furniture_repair", name: "­ƒøï´©Å Restauraci├│n y Tapicer├¡a de Muebles (furniture_repair)" },
                            { id: "wellness_podology", name: "­ƒÆå Est├®tica, Podolog├¡a y Bienestar (wellness_podology)" },
                            { id: "grocery_food", name: "­ƒìÄ Minimarkets y Alimentos (grocery_food)" }
                          ]}
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <label className="flex items-center gap-2.5 cursor-pointer text-xs font-semibold text-[var(--color-text-muted)] select-none">
                          <input 
                            ...
                            className="w-4 h-4 rounded accent-indigo-600 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] focus:ring-0 focus:outline-none"
                          />
                          Desplegar reglas e ├¡ndices en Firebase
                        </label>
                        ...
                        <div className="pl-6 border-l border-indigo-500/20 space-y-3 mt-1">
                          <label className="flex items-center gap-2.5 cursor-pointer text-xs font-semibold text-[var(--color-text-muted)] select-none">
                            <input 
                              ...
                              className="w-4 h-4 rounded accent-indigo-600 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] focus:ring-0 focus:outline-none"
                            />
                            Facturaci├│n Electr├│nica DIAN Directa
                          </label>

                                </div>
                      </div>

                      {/* Selector de Recomendaciones de la Biblioteca ÔÇö Premium Toggle Cards */}
                      <div className="border-t border-[var(--color-border)] pt-3.5 space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-[10px] font-bold text-[var(--color-text-muted)] uppercase tracking-wider">Recomendaciones de Biblioteca y M├│dulos</label>
                        ...
                        <div className="bg-[var(--color-bg)]/60 border border-[var(--color-border)] rounded-xl p-2.5 max-h-64 overflow-y-auto space-y-3 scrollbar-thin">
                          {libraryList.length === 0 ? (
                            <div className="flex items-center gap-2 py-3 justify-center">
                              ...
                              <span className="text-[10px] text-[var(--color-text-muted)] italic">Cargando cat├ílogo de componentes...</span>
                            </div>
                          ) : (
                      ...
                      <div className="border-t border-[var(--color-border)] pt-3.5 space-y-1.5">
                        ...
                        <textarea 
                          ...
                          placeholder="Especificaciones o notas custom de negocio... (ej: El cliente requiere que la facturaci├│n valide c├®dula de extranjer├¡a...)"
                          rows={3}
                ...
                <button 
                  ...
                  onClick={async () => {
                    ...
                    const cliPayload = {
                      ...
                      enableDianBilling,
                      costoPorFacturaDian,
                      selectedRecomendations, // Inyecci├│n de componentes/m├│dulos seleccionados
                      branding: {
                        primaryColor,
                        secondaryColor,
                        bgColor,
                    ...
                    try {
                      ...
                      try {
                        ...
                        if (cliRes.ok) {
                          ...
                          addLog(`[CLI API] Aprovisionamiento f├¡sico del proyecto en disco completado correctamente.`, "success")
                          ...
                          addLog(`[CLI API Warning] CLI respondi├│ con error: ${errMessage}. Datos guardados en Firestore ÔÇö puedes reintentar.`, "warning")
                          setPendingCliProvisioning({
                            clientId, nombre: newClientName.trim(), comisionPorcentaje, telemetryToken,
                            payload: cliPayload
                          })
                          showToast(`El cliente se guard├│ en Firestore. Presiona "Reintentar" cuando el CLI est├® disponible.`, { type: 'error' })
                        }
                      } catch (cliErr) {
                        console.error("Error en API de aprovisionamiento:", cliErr)
                        addLog(`[CLI API Warning] Daemon CLI offline o error de conexi├│n: ${cliErr.message}. Datos en Firestore seguros ÔÇö usa el bot├│n Reintentar cuando el CLI est├® disponible.`, "warning")
                        setPendingCliProvisioning({
                          clientId, nombre: newClientName.trim(), comisionPorcentaje, telemetryToken,
                          payload: cliPayload
                        })
                        showToast('Daemon CLI offline. Firestore OK. Presiona "Reintentar" cuando el servidor est├® disponible.', { type: 'error' })
                      }
            ...
            <div className="lg:col-span-5 relative h-full">
              ...
              <div className="text-center mb-3">
                ...
                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Interact├║a con el mockup: registra ventas, cambia de pesta├▒a y edita ajustes.</p>
              </div>
                ...
                <div className="h-full w-full flex flex-col justify-between relative overflow-hidden rounded-[22px] p-3 pt-5">
                  ...
                  <div className="flex items-center justify-between mt-1 shrink-0">
                    ...
                    <div className="w-5 h-5 rounded-full bg-slate-500/10 flex items-center justify-center cursor-pointer hover:bg-slate-500/20 transition-colors">
                      <span className="text-[8px]">­ƒöö</span>
                    </div>
                  </div>
                      ...
                      <div className="space-y-3">
                        ...
                        {mockIsNewSaleOpen ? (
                          ...
                          <button 
                            ...
                            style={{ backgroundColor: primaryColor }}
                          >
                            <span>ÔÜí Registrar Nueva Venta</span>
                          </button>
                        )}

                        {/* Recent History (Top 3) */}
                        <div className="space-y-1.5">
                          <span className="text-[8px] opacity-70 uppercase font-bold tracking-wider block">├Ültimas Ventas</span>
                          {mockOrders.length === 0 ? (
                    ...
                    {mockActiveTab === 'ventas' && (
                      <div className="space-y-3">
                        ...
                        <div className="p-2 rounded-2xl bg-slate-500/5 border border-slate-500/10 space-y-1.5">
                          <span className="text-[8px] opacity-70 uppercase font-bold tracking-wider block">Distribuci├│n de Ventas</span>
                          {mockOrders.length === 0 ? (
                            <div className="h-10 flex items-center justify-center text-[8px] opacity-50 italic">Sin datos de gr├ífico</div>
                          ) : (
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="space-y-1.5 max-h-[160px] overflow-y-auto pr-0.5 scrollbar-none">
                            {mockOrders.length === 0 ? (
                              <p className="text-[8px] opacity-50 italic text-center py-4">No hay ventas. ┬íRegistra una!</p>
                            ) : (
                              mockOrders.map((item) => (
                                <div 
                                  key={item.id} 
                    ...
                    {mockActiveTab === 'catalogo' && (
                      <div className="space-y-3 animate-fade-in">
                        <span className="text-[8px] opacity-70 uppercase font-bold tracking-wider block">
                          {['technical_services', 'refrigeration_ac', 'contractors', 'machinery_rental', 'laundry', 'furniture_repair', 'wellness_podology'].includes(niche) ? '­ƒôî Servicios de la Marca' : '­ƒÅÀ´©Å Cat├ílogo de Productos'}
                        </span>
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  showToast(`A├▒adido: ${item.name}`, { type: 'success' });
                                }}
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 p-2 rounded-2xl bg-slate-500/5 border border-slate-500/10 text-[8px]">
                          ...
                          <div className="flex items-center justify-between py-1">
                            ...
                            >
                              {mockTheme === 'dark' ? '­ƒîÖ Oscuro' : 'ÔÿÇ´©Å Claro'}
                            </button>
                          </div>
                          ...
                          {/* Billing module sync */}
                          <div className="flex items-center justify-between py-1 border-t border-slate-500/10">
                            <span className="font-bold">M├│dulo de Facturaci├│n</span>
                            <button
                              type="button"
                        ...
                        <div className="p-2 rounded-xl bg-indigo-500/10 border border-indigo-500/15 text-center text-[7.5px] text-indigo-400">
                          Ôä╣´©Å Los interruptores de PWA, Push y Facturaci├│n modifican el formulario de registro en tiempo real.
                        </div>
                      </div>
                    )}
                  ...
                  <div className="border-t border-slate-500/15 pt-2 flex justify-around text-[8px] opacity-90 shrink-0">
                    ...
                    >
                      ...
                      <span className="font-bold">
                        {['technical_services', 'refrigeration_ac', 'contractors', 'machinery_rental', 'laundry', 'furniture_repair', 'wellness_podology'].includes(niche) ? 'Servicios' : 'Cat├ílogo'}
                      </span>
                    </button>
                    <button 
                      type="button"
        ...
        {/* Modal de Selecci├│n de Fuentes (Google Fonts) */}
        {isFontModalOpen && (
            ...
            <div className="relative w-full max-w-2xl bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-6 shadow-2xl animate-scale-up max-h-[80vh] flex flex-col overflow-hidden transition-colors duration-300">
              ...
              <div className="flex items-center justify-between border-b border-[var(--color-border)] pb-4 mb-4 shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="font-extrabold text-sm text-[var(--color-text)]">Seleccionar Tipograf├¡a</h3>
              ...
              <div className="mb-3 shrink-0">
                <div className="flex items-center gap-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] px-3.5 py-2 rounded-xl shadow-sm focus-within:border-indigo-500/50 transition-colors duration-300">
                  ...
                  <input 
                    type="text" 
                    placeholder="Buscar tipograf├¡a por nombre..."
                      ...
                      >
                        ...
                        <div className="p-2.5 bg-[var(--color-bg)]/80 rounded-xl border border-[var(--color-border)] w-full text-center transition-colors">
                          ...
                          <p 
                            ...
                            style={{ fontFamily: `'${font.value}', sans-serif` }}
                          >
                            El veloz murci├®lago com├¡a feliz cardo.
                          </p>
                        </div>
        ...
        {/* Modal de Previsualizaci├│n en Vivo */}
              ...
              <div className="px-6 py-4 border-b border-[var(--color-border)] bg-[var(--color-surface)] z-10 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] uppercase font-black bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2 py-0.5 rounded-full flex items-center gap-1">
                    <Play size={8} fill="currentColor" /> Previsualizaci├│n en Vivo
                  </span>
              ...
              <div className="px-6 py-3 border-t border-[var(--color-border)] bg-[var(--color-surface)] z-10 flex items-center justify-end gap-3 shadow-md">
                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      {isSelected ? 'Remover de Recomendaciones' : 'A├▒adir a Recomendaciones'}
                    </button>
                  );
                })()}
              </div>
  ...
  // CONSTANTES DE NAVEGACI├ôN
  const NAV_TABS = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard, shortLabel: 'Inicio' },
    { id: 'billing', label: 'Facturaci├│n', icon: CreditCard, shortLabel: 'Cobros' },
  ...
  const rawFilteredFailures = failures.filter(f => {
    ...
    const matchesType = selectedErrorTypeFilter === 'todos' || 
      ...
      (!f.type && selectedErrorTypeFilter === 'error') // Default a error si no est├í definido
  ...
  // Agrupaci├│n / De-duplicaci├│n si est├í activo
  const filteredFailures = (() => {
    ...
    rawFilteredFailures.forEach(f => {
      ...
      if (!groups[key]) {
        ...
        // Conservar el reporte m├ís reciente como el principal para la UI
    ...
    // Devolver ordenados por fecha de m├ís reciente a m├ís antiguo
  ...
  const handleCopyWaMessage = () => {
    const msg = getWaPreview()
    copy(msg)
    showToast('Mensaje copiado al portapapeles Ô£ô', { type: 'success' })
  }
  ...
  return (
    <div className="h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-sans overflow-hidden selection:bg-violet-500/30 selection:text-violet-200 transition-colors duration-300 flex flex-col md:cursor-none">
      {/* Cursor personalizado ÔÇö solo desktop */}
      <CustomCursor />

      {/* ÔöÇÔöÇ Fondo tecnol├│gico premium: dots + orbs + vi├▒eta ÔöÇÔöÇ */}
      <div aria-hidden="true" className="tech-bg-dots" />
      <div aria-hidden="true" className="tech-bg-orb-1" />
      <div aria-hidden="true" className="tech-bg-orb-2" />
      <div aria-hidden="true" className="tech-bg-vignette" />
      ...
      <div className="flex flex-1 overflow-hidden relative z-10">
        ...
        <aside className={`hidden lg:flex flex-col shrink-0 border-r border-[var(--color-border)] bg-[var(--color-surface)]/80 backdrop-blur-md transition-all duration-300 ${
          ...
          {!sidebarCollapsed && (
            <div className="p-3 border-t border-[var(--color-border)] text-[9px] text-[var(--color-text-muted)] font-mono">
              v{new Date().getFullYear()} ┬À PROTOTIPE ENGINE
            </div>
          )}
        </aside>
        ...
        <main className="flex-1 overflow-y-auto scrollbar-thin pb-24 lg:pb-8">
          ...
          {/* Alerta de Simulaci├│n (siempre visible) */}
          {isSimulated && (
            <div className="p-3.5 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex items-start gap-3 text-xs text-amber-800 dark:text-amber-400/90 relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-[10px] opacity-80 mt-0.5">Los cambios son en memoria. Configura <code className="font-mono">VITE_DEVELOPER_CENTRAL_*</code> en <code className="font-mono">.env.local</code> para producci├│n.</p>
              </div>
            </div>
          )}
          ...
          {pendingCliProvisioning && (
            <div className="p-4 bg-red-500/10 border border-red-500/25 rounded-2xl flex flex-col sm:flex-row sm:items-center gap-4 relative overflow-hidden shadow-sm">
              ...
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="space-y-0.5">
                  <p className="text-xs font-extrabold text-red-400 uppercase tracking-wider">Aprovisionamiento f├¡sico pendiente</p>
                  <p className="text-[11px] text-[var(--color-text-muted)] leading-relaxed">
                    El cliente <strong className="text-[var(--color-text)] font-mono">{pendingCliProvisioning.clientId}</strong> fue registrado en Firestore, pero el daemon CLI (puerto 3001) no respondi├│.
                  </p>
                </div>
              </div>
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-6 tab-content-enter">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                  <h1 className="text-xl font-black text-[var(--color-text)] flex items-center gap-2.5 flex-wrap">
                    ...
                    >
                      ÔùÅ {isSimulated ? 'Modo Sandbox' : 'Conectado a Firestore'}
                    </button>
                  </h1>
                  <p className="text-xs text-[var(--color-text-muted)] mt-0.5">Visi├│n consolidada de ingresos y estado del sistema en tiempo real.</p>
                </div>
                <div className="grid grid-cols-1 sm:flex sm:flex-row gap-2 w-full lg:w-auto items-center shrink-0">
                  ...
                  <div ref={periodPickerRef} className="relative w-full sm:w-auto">
                    ...
                    >
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>{selectedPeriod ? getPeriodLabel(selectedPeriod) : 'Hist├│rico Completo'}</span>
                      </div>
                        ...
                        {selectedPeriod && (
                          <button
                            ...
                            onClick={() => {
                              ...
                              setIsPeriodPickerOpen(false)
                              addLog('Filtro de periodo restablecido. Mostrando hist├│rico.', 'info')
                            }}
                  ...
                  <button onClick={() => {
                      ...
                      addLog('Reporte de rendimiento y m├®tricas generales PDF exportado.', 'success')
                    }}
                    className="px-3.5 py-2.5 sm:py-2 rounded-xl bg-[var(--color-surface-2)] hover:bg-[var(--color-border)] text-[var(--color-text-muted)] hover:text-[var(--color-text)] text-xs font-bold flex items-center justify-center gap-1.5 transition-all border border-[var(--color-border)] active:scale-[0.98] cursor-pointer w-full sm:w-auto">
                    <Download size={13} className="text-indigo-400" />
                    <span>Exportar M├®tricas</span>
                  </button>
                  <button onClick={() => {
                      const period = new Date().toISOString().substring(0, 7)
                      exportConsolidatedReconciliationPDF(period, clientesSaas, reports)
                      addLog(`Reporte de conciliaci├│n PDF exportado para el periodo ${period}.`, 'success')
                    }}
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  { label: 'Comisi├│n Acumulada', val: totalComision, icon: TrendingUp, col: 'from-violet-500/20 to-violet-500/5 dark:from-violet-500/10 dark:to-violet-500/2', iconCol: 'text-violet-650 dark:text-violet-400', type: 'comision' },
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
                ...
                <div className="lg:col-span-2 bg-[var(--color-surface)] p-6 rounded-2xl flex flex-col shadow-sm relative overflow-hidden transition-colors duration-300 border border-[var(--color-border)]">
                  ...
                  <div className="flex items-center justify-between mb-5 flex-wrap gap-2">
                    <div className="space-y-1">
                      <span className="text-[9px] font-bold text-violet-500 dark:text-violet-400 uppercase tracking-wider">M├®tricas</span>
                              ...
                              if (active && payload && payload.length) {
                                ...
                                return (
                                  <div className="bg-slate-950/90 backdrop-blur-md border border-white/[0.08] p-3 rounded-2xl shadow-2xl text-left text-[10px] space-y-1">
                                    ...
                                    <p className="text-violet-400 font-semibold">Comisi├│n: <span className="font-bold font-mono">${data.comisiones.toLocaleString('es-CO')}</span></p>
                  ...
                  {chartData.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {chartData.map((client, idx) => {
                        ...
                        // Encontrar la configuraci├│n del cliente
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="flex items-center gap-4 text-right min-w-[90px] justify-end">
                                <div>
                                  <span className="text-[9px] uppercase font-bold tracking-wider text-[var(--color-text-muted)] block leading-none">Comisi├│n</span>
                            ...
                            {/* Panel Desplegable con Gr├ífico e Informaci├│n */}
                              ...
                              {isExpanded && (
                                ...
                                >
                                  <div className="pt-4 border-t border-[var(--color-border)]/40 mt-3 space-y-4">
                                    {/* Gr├ífico individual del cliente */}
                                                ...
                                                if (active && payload && payload.length) {
                                                  ...
                                                  return (
                                                    <div className="bg-slate-950/90 backdrop-blur-md border border-white/[0.08] p-2.5 rounded-xl shadow-2xl text-left text-[9px] space-y-0.5">
                                                      ...
                                                      <p className={`${colorSet.text}`}>Comisi├│n: <span className="font-bold font-mono">${data.comisiones.toLocaleString('es-CO')}</span></p>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[10px] bg-[var(--color-surface)]/40 p-2.5 rounded-xl border border-[var(--color-border)]/40">
                                      <div>
                                        <span className="text-[8px] text-[var(--color-text-muted)] uppercase font-semibold block">Esquema Facturaci├│n</span>
                ...
                {/* Columna Derecha: Radar de Salud + Telemetr├¡a */}
                <div className="space-y-5">
                  ...
                  {/* Consola de Telemetr├¡a (Estilo Ventana de Comandos Real e Interactiva) */}
              ...
              <div className="bg-[var(--color-surface)] p-6 rounded-2xl shadow-sm border border-[var(--color-border)] transition-colors duration-300">
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Proyecta tu crecimiento a├▒adiendo nuevas tiendas sobre la base actual de clientes.</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="space-y-1">
                    <label className="text-[9px] uppercase font-bold text-[var(--color-text-muted)] block">Nuevas Tiendas a A├▒adir</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-indigo-500/10 border border-indigo-500/25 rounded-xl">
                    <span className="text-[9px] uppercase font-bold tracking-wider text-indigo-400 block">Proyecci├│n Total / Mes</span>
                  ...
                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/25 rounded-xl">
                    <span className="text-[9px] uppercase font-bold tracking-wider text-emerald-400 block">Proyecci├│n {projMonths} Meses</span>
                  ...
                  <div className="flex-1 min-w-[280px] bg-[var(--color-surface-2)]/25 border border-[var(--color-border)]/45 p-4 rounded-xl flex flex-col justify-between">
                    <div>
                      <h4 className="text-[10px] uppercase font-bold tracking-wider text-[var(--color-text-muted)] flex items-center gap-1.5 mb-3">
                        ...
                        Rentabilidad por Nicho (Participaci├│n)
                      </h4>
                  ...
                  <div className="flex-1 min-w-[280px] bg-[var(--color-surface-2)]/25 border border-[var(--color-border)]/45 p-4 rounded-xl flex flex-col justify-between font-mono text-[10px]">
                    <div>
                      <h4 className="text-[10px] uppercase font-bold tracking-wider text-[var(--color-text-muted)] flex items-center gap-1.5 mb-3 font-sans">
                        ...
                        Eficiencia Financiera (M├írgenes Netos)
                      </h4>
                      <p className="text-[8px] text-[var(--color-text-muted)] leading-relaxed mb-4 font-sans">
                        Costo DIAN restado de la facturaci├│n comisional ($150 COP por reporte emitido con DIAN activo).
                      </p>
                      
                      <div className="space-y-2.5">
                        <div className="flex justify-between items-center text-[10px] border-b border-[var(--color-border)]/40 pb-2">
                          <span className="text-[9px] text-[var(--color-text-muted)] font-sans">Costo DIAN Hist├│rico</span>
                          <span className="font-bold text-red-400">-${biMetrics.existingDianCost.toLocaleString('es-CO')}</span>
                        </div>
                        <div className="flex justify-between items-center text-[10px] border-b border-[var(--color-border)]/40 pb-2">
                          <span className="text-[9px] text-[var(--color-text-muted)] font-sans">Margen Neto Hist├│rico</span>
            ...
            <div className="space-y-6 tab-content-enter">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-[var(--color-border)]">
                <div>
                  ...
                  <p className="text-xs text-[var(--color-text-muted)] mt-0.5">Directorio completo, configuraci├│n de facturaci├│n y portal de cada cliente.</p>
                </div>
              ...
              {/* Contenido CRM existente ÔÇö modal de m├®trica reutilizado inline */}
              {/* Sub-pesta├▒as CRM */}
              ...
              {crmSubTab === 'directorio' ? (
                <div className="space-y-3">
                      ...
                      <div key={client.name} className="bg-[var(--color-surface)] p-4 rounded-2xl border border-[var(--color-border)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-indigo-500/30 transition-all">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-[var(--color-text-muted)]">{client.reportCount} reportes ┬À {client.pendingCount} pendientes</p>
                          </div>
                        </div>
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between w-full lg:w-auto gap-4 mt-2 lg:mt-0 pt-3 lg:pt-0 border-t border-[var(--color-border)] lg:border-t-0">
                          <div className="flex items-center gap-6 pr-2">
                            ...
                            <div>
                              <span className="text-[8px] uppercase font-bold text-[var(--color-text-muted)] block">Comisi├│n</span>
                  ...
                  {Object.values(clientAggregated).filter(c => c.name.toLowerCase().includes(crmSearch.toLowerCase())).length === 0 && (
                    <div className="p-12 text-center text-slate-500 text-xs">No hay clientes que coincidan con la b├║squeda.</div>
                  )}
                </div>
              ) : crmSubTab === 'paridad' ? (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <p className="text-xs text-[var(--color-text-muted)]">Mapa de paridad f├¡sica del c├│digo del ecosistema respecto a los Cores de Referencia.</p>
                                ...
                                {drift.parityPercent < 100 && (
                                  <button onClick={async () => {
                                    ...
                                    try {
                                      ...
                                      if (resData.success) {
                                        showToast(`Sincronizaci├│n masiva para ${client.name} completada con ├®xito.`, { type: 'success' });
                                        fetchGlobalDrift();
                                      } else {
                              ...
                              <div>
                                ...
                                <span className="text-[8px] text-[var(--color-text-muted)]">
                                  {item.firestore.error ? `Error: ${item.firestore.error}` :
                                   ...
                                   item.firestore.drift ? 'ÔÜá´©Å Desviado del Core' : 'Ô£à Alineado'}
                                </span>
                              </div>
                              <div className="flex gap-1">
                              ...
                              <div>
                                ...
                                <span className="text-[8px] text-[var(--color-text-muted)]">
                                  {item.storage.error ? `Error: ${item.storage.error}` :
                                   ...
                                   item.storage.drift ? 'ÔÜá´©Å Desviado del Core' : 'Ô£à Alineado'}
                                </span>
                              </div>
                              <div className="flex gap-1">
            ...
            <div className="space-y-6 tab-content-enter">
              ...
              <div className="bg-[var(--color-surface)] rounded-2xl overflow-hidden shadow-sm border border-[var(--color-border)] transition-colors duration-300">
                ...
                {isLoading ? (
                  ...
                  <div className="p-16 text-center text-slate-500 text-xs">Ning├║n reporte coincide con los filtros.</div>
                ) : (
                    ...
                    <table className="w-full text-left text-xs border-collapse">
                      <thead>
                        <tr className="border-b border-[var(--color-border)] text-[var(--color-text-muted)] bg-[var(--color-surface-2)]/70 font-bold">
                          ...
                          <th className="p-4 text-right uppercase tracking-wider text-[10px]">Comisi├│n</th>
                          <th className="p-4 text-center uppercase tracking-wider text-[10px]">Estado</th>
                          <th className="p-4 pr-5 text-right uppercase tracking-wider text-[10px]">Transmisi├│n</th>
                        </tr>
                      </thead>
              ...
              <div className="bg-[var(--color-surface)] p-6 rounded-2xl shadow-sm border border-[var(--color-border)] transition-colors duration-300">
                <div className="mb-5">
                  ...
                  <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Personaliza y env├¡a recordatorios de cobro con campos din├ímicos a tus clientes.</p>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1 sm:col-span-2">
                        <label className="text-[9px] uppercase font-bold text-[var(--color-text-muted)] block">Comisi├│n Manual ({'{comision}'}) <span className="font-normal">ÔÇö Opcional, se auto-calcula si est├í vac├¡o</span></label>
                        <input type="text" placeholder="Ej: 102,750 (dejar vac├¡o para auto-calcular)" value={waComision} onChange={e => setWaComision(e.target.value)}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-xl">
                      <p className="text-[9px] text-[var(--color-text-muted)] font-mono leading-relaxed">
                        Variables disponibles: <span className="text-indigo-400">{'{cliente}'}</span> ┬À <span className="text-indigo-400">{'{periodo}'}</span> ┬À <span className="text-indigo-400">{'{comision}'}</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'onboarding' && (
            <div className="tab-content-enter h-full">
              {isOnboardingActive ? (
                <div className="text-center text-xs text-[var(--color-text-muted)] p-8">El asistente de aprovisionamiento est├í activo en la vista de pantalla completa.</div>
              ) : (
                <div className="space-y-6">
                  ...
                  <div className="relative overflow-hidden w-full min-h-[420px] flex items-center justify-center rounded-3xl border border-[var(--color-border)] shadow-2xl p-8 sm:p-12 transition-all duration-300">
                    {/* Interactive Ambient Glow Background ÔÇö ocupa todo el contenedor */}
                    ...
                    <div className="relative z-10 text-center max-w-xl mx-auto space-y-6 p-6 sm:p-8 rounded-2xl bg-[var(--color-surface-2)]/60 dark:bg-[var(--color-surface-2)]/45 backdrop-blur-xl border border-[var(--color-border)] shadow-xl transition-all duration-500 hover:shadow-indigo-500/10">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-[var(--color-text-muted)] max-w-md mx-auto leading-relaxed">
                          Crea, configura y despliega una instancia exclusiva a la medida del cliente en segundos. Define servidor, branding visual y m├│dulos del negocio.
                        </p>
                      </div>
                      ...
                      <table className="w-full text-left border-collapse hidden md:table">
                        <thead>
                          <tr className="border-b border-[var(--color-border)] text-[10px] uppercase font-bold tracking-wider text-[var(--color-text-muted)] bg-[var(--color-surface-2)]/40 select-none">
                            ...
                            <th className="p-4">Comisi├│n / Tarifa</th>
                            <th className="p-4">Facturaci├│n DIAN</th>
                        ...
                        <tbody className="divide-y divide-[var(--color-border)] text-xs">
                          {paginatedProvisionings.length === 0 ? (
                            ...
                            paginatedProvisionings.map(client => {
                              const nicheData = [
                                { id: "retail_clothing", emoji: "­ƒøì´©Å", name: "Ropa y Retail" },
                                { id: "technical_services", emoji: "ÔÜÖ´©Å", name: "Torner├¡as y Mecanizado" },
                                { id: "refrigeration_ac", emoji: "ÔØä´©Å", name: "Refrigeraci├│n/AC" },
                                { id: "contractors", emoji: "­ƒôÉ", name: "Contratistas" },
                                { id: "machinery_rental", emoji: "­ƒÜ£", name: "Alquiler Maquinaria" },
                                { id: "carpentry", emoji: "­ƒ¬Ü", name: "Carpinter├¡as" },
                                { id: "laundry", emoji: "­ƒº║", name: "Lavander├¡as" },
                                { id: "furniture_repair", emoji: "­ƒøï´©Å", name: "Restauraci├│n/Tapicer├¡a" },
                                { id: "wellness_podology", emoji: "­ƒÆå", name: "Est├®tica/Podolog├¡a" },
                                { id: "grocery_food", emoji: "­ƒìÄ", name: "Minimarkets/Alimentos" }
                              ].find(n => n.id === client.niche) || { emoji: "­ƒôª", name: client.niche || "Desconocido" }
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <h1 className="text-xl font-black text-[var(--color-text)] flex items-center gap-2.5">
                    ...
                    Consola de Errores y Diagn├│stico
                  </h1>
                    ...
                    <div className="flex items-center gap-1.5">
                      <CustomSelect
                        ...
                        options={[
                          ...
                          { id: 'error', label: '­ƒö┤ Errores' },
                          { id: 'warning', label: '­ƒƒí Advertencias' },
                          { id: 'info', label: '­ƒöÁ Informaci├│n' }
                        ]}
                          ...
                          >
                              ...
                              <div className="space-y-1 flex-1 min-w-0">
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  <span className="text-[10px] text-slate-500 font-mono">
                                    ÔÇó {new Date(fail.timestamp).toLocaleString()}
                                  </span>
                            ...
                            {resolutionNoteInputId === fail.id && (
                              <div className="mt-3 p-3.5 bg-[var(--color-surface-2)]/60 border border-[var(--color-border)] rounded-xl space-y-2 animate-fade-in">
                                <span className="text-[9px] uppercase font-black text-slate-500 tracking-wider font-mono">Nota de Soluci├│n (Opcional):</span>
                                <div className="flex gap-2">
                                  <input
                                    type="text"
                                    placeholder="Ej: Creado ├¡ndice compuesto, corregido error de null..."
                                ...
                                <div className="flex items-center gap-1.5 text-emerald-400 font-bold">
                                  ...
                                  {fail.resolvedAt && (
                                    <span className="text-slate-500 font-mono font-normal">
                                      ÔÇó {new Date(fail.resolvedAt).toLocaleString()}
                                    </span>
                                  )}
                                </div>
                                {fail.resolutionNote && (
                            ...
                            {isExpanded && (
                              <div className="mt-3.5 space-y-1.5 animate-fade-in">
                                <span className="text-[9px] uppercase font-black text-slate-500 tracking-wider font-mono">Stack Trace Diagn├│stico:</span>
            ...
            <div className="space-y-6 tab-content-enter">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="bg-[var(--color-surface)] p-5 rounded-2xl border border-[var(--color-border)] space-y-4">
                  <h3 className="font-extrabold text-sm text-[var(--color-text)]">Entorno y Telemetr├¡a</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-xs">
                      <div>
                        <p className="font-bold text-[var(--color-text)]">Modo de Ejecuci├│n</p>
                ...
                <div className="bg-[var(--color-surface)] p-5 rounded-2xl border border-[var(--color-border)] space-y-4">
                  <h3 className="font-extrabold text-sm text-[var(--color-text)]">Sesi├│n</h3>
                  <div className="space-y-3">
              ...
              {/* Panel de Telemetr├¡a Centralizada Multi-Cliente (Premium Matrix) */}
                ...
                <div className="space-y-4">
                  <div className="bg-[var(--color-surface)] p-5 rounded-3xl border border-[var(--color-border)] shadow-md">
                    ...
                    <p className="text-[10px] text-[var(--color-text-muted)] mt-1">
                      Monitoreo de estado por cliente. Haz clic en una tarjeta para filtrar sus logs de telemetr├¡a.
                    </p>
                  </div>
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 min-w-0">
                              <span className="text-base select-none shrink-0">
                                {client.niche === 'wellness_podology' ? '­ƒªÂ' :
                                 client.niche === 'retail_clothing' ? '­ƒæò' :
                                 client.niche === 'technical_services' ? '­ƒøá´©Å' :
                                 client.niche === 'refrigeration_ac' ? 'ÔØä´©Å' :
                                 client.niche === 'contractors' ? '­ƒæÀ' :
                                 client.niche === 'machinery_rental' ? '­ƒÜ£' :
                                 client.niche === 'carpentry' ? '­ƒ¬Ü' :
                                 client.niche === 'laundry' ? '­ƒº║' :
                                 client.niche === 'furniture_repair' ? '­ƒøï´©Å' :
                                 client.niche === 'grocery_food' ? '­ƒøÆ' : '­ƒôª'}
                              </span>
                          ...
                          <div className="grid grid-cols-2 gap-2 mt-3.5">
                            <div 
                              ...
                              title="Ver diagn├│sticos en pesta├▒a errores"
                            >
                              <span>ÔÜá´©Å Fallos</span>
                            ...
                            <div 
                              ...
                              title="Ver facturas en pesta├▒a facturaci├│n"
                            >
                              <span>­ƒÆ│ Cobros</span>
                    ...
                    <div className="relative z-1 space-y-4 flex-1 flex flex-col">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-[var(--color-border)]/65 pb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-extrabold text-sm text-[var(--color-text)] flex items-center gap-2">
                             Consola de Telemetr├¡a del Sistema en Vivo
                            ...
                            <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5 font-mono">
                              telemetry_monitor.sh ÔÇó {!isOnline ? 'Red Fuera de L├¡nea' : (isSimulated ? 'Modo Sandbox' : 'Conectado a Firestore Central')}
                            </p>
                          </div>
                        </div>
                        
                        {/* Botones de acci├│n y filtros r├ípidos */}
                              ...
                              >
                                ...
                                <div className="flex items-start justify-between gap-4">
                                  <p className="font-mono text-[10px] text-slate-300 leading-relaxed break-words pl-1 flex-1">
                                    <span className="text-slate-500 mr-1 select-none">Ô×ö</span>
                                    {log.message}
                                  </p>
                                  {isClickable && (
                                    <button
      ...
      {/* Modal de Detalle y Gesti├│n de Cliente (CRM) */}
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          <div className="relative w-full max-w-2xl bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-6 shadow-2xl animate-scale-up space-y-5 max-h-[90vh] overflow-y-auto">
            ...
            {crmTab === 'config' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-2xl space-y-3">
                    <label className="flex items-center gap-2.5 cursor-pointer text-xs font-semibold text-[var(--color-text-muted)] select-none">
                      ...
                      />
                      Habilitar Facturaci├│n Electr├│nica DIAN Directa
                    </label>
                      ...
                      <div className="space-y-3 animate-fade-in pl-6 border-l border-indigo-500/20">
                        <div className="space-y-1">
                          ...
                          <CustomSelect
                            ...
                            options={[
                              { value: "info", label: "Informaci├│n (Azul)" },
                        ...
                        <div className="space-y-1">
                          <label className="text-[10px] font-bold text-[var(--color-text-muted)] block">T├¡tulo de la Alerta</label>
                          <input 
                            type="text" 
                            value={editAlertTitle} 
                            onChange={(e) => setEditAlertTitle(e.target.value)}
                            placeholder="Ej: Prueba de Enlace de Telemetr├¡a"
                            className="bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-xl px-3 py-2 text-xs w-full text-[var(--color-text)] outline-none focus:border-indigo-500"
                          />
                        </div>
              ...
              <>
                {/* Panel de Sincronizaci├│n Core (Drift) */}
                <div className="space-y-4">
                  {driftLoading ? (
                    <div className="flex flex-col items-center justify-center py-12 space-y-2">
                      <RefreshCw size={24} className="animate-spin text-indigo-500" />
                      <span className="text-xs text-[var(--color-text-muted)]">Analizando desviaci├│n respecto al Core...</span>
                    </div>
                  ) : driftData ? (
                    <div className="space-y-4">
                      {/* Resumen de paridad */}
                      <div className="flex items-center justify-between bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-2xl p-4">
                        <div>
                          <p className="text-xs font-black text-[var(--color-text)]">├ìndice de Paridad de C├│digo</p>
                        ...
                        {driftData.differences.length === 0 ? (
                          <div className="text-center py-10 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                            <p className="text-xs font-bold text-emerald-400 flex items-center justify-center gap-1.5">
                              <CheckCircle size={14} />
                              ┬íC├│digo 100% Alineado!
                            </p>
                            <p className="text-[10px] text-emerald-300/60 mt-1">Esta instancia de cliente no presenta desviaciones f├¡sicas con el Core.</p>
                          </div>
                        ) : (
                            ...
                            <div key={idx} className="flex items-center justify-between p-3 bg-[var(--color-surface-2)]/10 border border-[var(--color-border)] rounded-xl hover:bg-[var(--color-surface-2)]/20 transition-all">
                              <div className="space-y-0.5">
                                ...
                                <p className="text-[9px] text-[var(--color-text-muted)]">
                                  {diff.status === 'missing_in_client' ? 'ÔÜá´©Å Archivo ausente en cliente' : 'Ô£Å´©Å Archivo modificado/desviado'}
                                </p>
                              </div>
                    ...
                    <p className="text-xs text-[var(--color-text-muted)] italic text-center py-6">Selecciona cargar desviaci├│n para comparar archivos.</p>
                  )}
                </div>
      ...
      {/* Modal de Detalle de Comisi├│n Acumulada */}
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  onClick={() => {
                    ...
                    addLog('Reporte general de m├®tricas exportado a PDF.', 'success')
                  }}
      ...
      {/* Modal de Detalle de Comisi├│n Cobrada */}
      ...
      {/* Modal de Detalle de Comisi├│n Pendiente */}
                ...
                <table className="w-full text-left border-collapse text-[10px]">
                  ...
                  <tbody className="divide-y divide-[var(--color-border)]/40 font-mono text-[9px] text-[var(--color-text-muted)]">
                    ...
                    {filteredPeriodReports.filter(r => r.estadoPago !== 'pagado').length === 0 && (
                      <tr>
                        <td colSpan="5" className="p-6 text-center text-xs text-[var(--color-text-muted)] italic font-sans">
                          ┬íNo hay comisiones pendientes de cobro! Excelente salud financiera.
                        </td>
                      </tr>
                    )}
                  </tbody>
          ...
          <div className="relative w-full max-w-3xl bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-6 shadow-2xl animate-scale-up space-y-4 max-h-[85vh] overflow-y-auto flex flex-col">
            ...
            <div className="flex-1 bg-slate-950 border border-slate-800 rounded-xl p-4 overflow-auto font-mono text-[10px] whitespace-pre-wrap leading-relaxed max-h-[50vh]">
              {activeDiffFile.diff ? (
                ...
                <p className="text-slate-400">Archivo nuevo (sin diferencias de l├¡neas).</p>
              )}
            </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          <div className="relative w-full max-w-lg bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-6 shadow-2xl animate-scale-up space-y-5 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-[var(--color-border)] pb-3">
              <h3 className="font-black text-sm uppercase text-indigo-500 tracking-wider flex items-center gap-2">
                <CheckCircle size={16} />
                Onboarding & Checklist de Integraci├│n
              </h3>
              <button 
            ...
            <div className="p-4 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-2xl space-y-3">
              <span className="text-[10px] uppercase font-bold text-indigo-400 tracking-widest block">Verificaci├│n de Configuraci├│n Manual de Firebase</span>
              <div className="space-y-2 text-xs">
                {[
                  { id: 'fs', label: 'Habilitar Firestore Database y desplegar reglas/├¡ndices' },
                  { id: 'auth', label: 'Habilitar Firebase Authentication (Correo/Contrase├▒a)' },
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3 bg-[var(--color-bg)] p-2.5 rounded-xl border border-[var(--color-border)] min-w-0">
                    ...
                    <button 
                      onClick={() => {
                        ...
                        showToast('Contrase├▒a copiada al portapapeles', { type: 'success' })
                      }}
                      className="p-1.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg cursor-pointer flex items-center justify-center shrink-0"
              ...
              <div className="p-4 bg-indigo-500/10 border border-indigo-500/25 rounded-2xl space-y-2">
                <span className="text-[10px] uppercase font-bold text-indigo-400 block tracking-widest">Token de Telemetr├¡a Generado</span>
...
VITE_DEVELOPER_CLIENT_ID=${onboardingData.clientId}`}
                  ...
                  <div className="p-3 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-xl flex gap-3 min-w-0">
                    ...
                    <div className="space-y-1 flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-[var(--color-text-muted)]">Aseg├║rate de vincular el proyecto correcto de Firebase en la configuraci├│n local de la CLI:</p>
    ...
    "default": "${CENTRAL_CONFIG.projectId || 'firebase-project-id'}"
                  ...
                  <div className="p-3 bg-[var(--color-surface-2)]/30 border border-[var(--color-border)] rounded-xl flex gap-3 min-w-0">
                    ...
                    <div className="space-y-1 flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-[var(--color-text-muted)]">Establece las credenciales correspondientes de Firebase Messaging en el Service Worker. Tu clave VAPID p├║blica es:</p>
                      {onboardingData.vapidKey ? (
                        ...
                        <p className="text-[10px] text-amber-500 italic mt-1.5">No se especific├│ clave VAPID key en la configuraci├│n del cliente.</p>
                      )}
                    </div>
                  </div>
                </div>
      ...
      {isProfileModalOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          <div className="w-full max-w-sm bg-slate-900/60 border border-slate-800/80 p-6 rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 space-y-6">
            ...
            {/* Informaci├│n del Sistema / Base de Datos */}
            ...
            {/* Accesos a Herramientas de Desarrollador en M├│vil */}
            ...
            {/* Acci├│n de Ajustes / Configuraci├│n */}
            <button 
              onClick={() => {
                setIsProfileModalOpen(false)
      ...
      {/* Drawer Lateral de Diagn├│stico Inteligente */}
      {selectedDiagnosticError && (
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                {(() => {
                  ...
                  if (errMsg.includes('Failed to fetch dynamically imported module')) {
                    diagnosis = "Error de carga del m├│dulo din├ímico de la p├ígina. Esto ocurre usualmente por desconexi├│n temporal de internet (modo offline) del usuario en el navegador, un cach├® corrupto del service worker, o si el archivo fue borrado o renombrado f├¡sicamente del disco.";
                    solution = "1. Verifica que el archivo de la p├ígina exista en la ruta especificada de la aplicaci├│n.\n2. Asegura que el router tenga correctamente declarada la importaci├│n perezosa.\n3. Si fue un corte de internet temporal del cliente en producci├│n, no requiere cambios en el c├│digo.";
                    ...
                    solution = "1. Revisa las reglas en `firestore.rules` asociadas a la colecci├│n afectada.\n2. Verifica si el usuario cuenta con los claims o roles necesarios en su sesi├│n de Firebase Auth.\n3. Aseg├║rate de invocar la limpieza de listeners `onSnapshot` al cerrar sesi├│n.";
                  } else if (fullText.includes('requires an index') || fullText.includes('index-creation') || indexUrl) {
                    diagnosis = "Falta de ├¡ndice compuesto en Firestore. Est├ís realizando una consulta compleja (con m├║ltiples filtros 'where' y/o un 'orderBy') que requiere la creaci├│n de un ├¡ndice espec├¡fico en la base de datos de Firebase.";
                    solution = "1. Crea el ├¡ndice haciendo clic en el enlace provisto por el SDK de Firebase.\n2. Aseg├║rate de que el ├¡ndice est├® habilitado antes de volver a realizar la consulta.\n3. Puedes usar el bot├│n directo de abajo para ir a la consola de Firebase.";
                  } else if (errMsg.includes('auth/user-not-found') || errMsg.includes('auth/wrong-password')) {
                    diagnosis = "Credenciales incorrectas o usuario inexistente. Se intent├│ iniciar sesi├│n o realizar una operaci├│n de autenticaci├│n con datos que no coinciden con los registros de Firebase Auth.";
                    solution = "1. Verifica que el correo est├® bien escrito y el usuario exista en Firebase Authentication.\n2. Aseg├║rate de que la contrase├▒a ingresada coincida.\n3. Implementa validaciones de cliente m├ís amigables.";
                  } else if (errMsg.includes('auth/network-request-failed')) {
                    diagnosis = "Fallo de conexi├│n de red de Firebase Auth. El cliente no pudo comunicarse con los servidores de autenticaci├│n de Google.";
                    solution = "1. Verifica la conexi├│n a internet en el dispositivo del cliente.\n2. Aseg├║rate de que no haya firewalls o extensiones (AdBlockers) bloqueando las llamadas a googleapis.com.";
                  } else if (errMsg.includes('Cannot read properties of') || errMsg.includes('is not a function')) {
                    diagnosis = "Referencia nula o undefined en JavaScript (Null Pointer Exception). Se intent├│ acceder a una propiedad o invocar una funci├│n en una variable que no ha sido inicializada.";
                    solution = "1. Utiliza encadenamiento opcional (optional chaining) como `objeto?.propiedad`.\n2. Verifica que las llamadas as├¡ncronas hayan completado la carga antes de renderizar los datos.\n3. Inicializa los estados de React con valores por defecto v├ílidos (ej. un array vac├¡o `[]` para listados).";
                  } else if (fullText.toLowerCase().includes('quota-exceeded') || fullText.toLowerCase().includes('resource-exhausted')) {
                    diagnosis = "Cuota de Firebase agotada o recurso exhausto. Se ha superado el l├¡mite diario de lecturas/escrituras del plan Spark gratuito o los l├¡mites generales de Firestore.";
                    solution = "1. Revisa las consultas y listeners en tiempo real que podr├¡an estar generando lecturas infinitas.\n2. Optimiza el caching local o considera subir al plan Blaze de pago por uso.\n3. Audita reportes repetitivos de telemetr├¡a.";
                  } else if (errMsg.includes('storage/unauthorized') || errMsg.includes('storage/canceled')) {
                    diagnosis = "Permisos denegados en Firebase Storage. Se intent├│ subir, borrar o leer un archivo (imagen, PDF, etc.) que no cumple con las reglas de seguridad de Storage.";
                    solution = "1. Revisa el archivo `storage.rules` en el proyecto.\n2. Aseg├║rate de que las reglas de escritura/lectura permitan la ruta y que el usuario est├® correctamente autenticado.\n3. Verifica si el formato o tama├▒o del archivo no excede l├¡mites l├│gicos.";
                  } else if (errMsg.includes('JSON.parse') || errMsg.includes('Unexpected token') || errMsg.toLowerCase().includes('json parse')) {
                    diagnosis = "Fallo de deserializaci├│n JSON (JSON Parse Error). Se intent├│ analizar una cadena de texto que no tiene formato JSON v├ílido o que es undefined/null.";
                    solution = "1. Verifica el origen del string (localstorage, API externa, etc.) y aseg├║rate de que sea un JSON v├ílido.\n2. Envuelve el parseo en un bloque `try-catch` para evitar ca├¡das de la aplicaci├│n.\n3. A├▒ade una validaci├│n previa: `if (typeof str === 'string' && str.trim())`.";
                  } else if (fullText.includes('blocked by CORS policy') || fullText.includes('No \'Access-Control-Allow-Origin\'')) {
                    diagnosis = "Bloqueo de CORS (Cross-Origin Resource Sharing). El navegador del usuario bloque├│ una solicitud HTTP saliente porque el servidor remoto no expone las cabeceras CORS necesarias.";
                    solution = "1. Si es una funci├│n propia de Firebase, aseg├║rate de haber configurado CORS: `cors({ origin: true })` en Node.js.\n2. Si es una API de terceros, verifica si necesitas un proxy o si debes registrar el dominio del cliente en la lista blanca de la API.";
                    ...
                    diagnosis = "Firestore sin conexi├│n (Offline). El cliente Firestore del navegador no pudo sincronizar o leer el documento porque el dispositivo est├í offline o Firestore est├í temporalmente inaccesible.";
                    solution = "1. Revisa la conectividad a internet del usuario final.\n2. Aseg├║rate de habilitar la persistencia offline de Firestore en la configuraci├│n inicial si deseas soporte sin red.\n3. Envuelve las lecturas clave en bloques de captura de excepciones.";
                  }
                  ...
                  const getFileAndLine = () => {
                    ...
                    // 2. Buscar en las l├¡neas del stack trace omitiendo librer├¡as comunes
                    const stackLines = (selectedDiagnosticError.stack || '').split('\n');
                    for (const line of stackLines) {
                      if (line.includes('node_modules') || line.includes('installHook.js') || line.includes('react-dom') || line.includes('react.development')) {
                        continue;
                    ...
                    // 4. ├Ültimo recurso: buscar nombre de archivo sin l├¡nea
                    ...
                    <>
                      <div className="space-y-4 bg-violet-500/5 border border-violet-500/15 p-5 rounded-2xl">
                        ...
                        <div className="space-y-3 text-xs leading-relaxed text-[var(--color-text-muted)]">
                          ...
                          <div>
                            <span className="font-extrabold text-[var(--color-text)] block mb-0.5">Soluci├│n Recomendada:</span>
                      ...
                      <div className="grid grid-cols-1 gap-2.5">
                        {indexUrl && (
                          ...
                          >
                            ...
                            Crear ├ìndice Compuesto en Firebase
                          </a>
                        )}

                        <button
                          onClick={async () => {
                            const promptText = `En el proyecto '${selectedDiagnosticError.clientId}', corrige el error '${selectedDiagnosticError.errorMsg}' que est├í ocurriendo en el archivo '${detectedFile}' (L├¡nea: ${detectedLine}, Niche: ${selectedDiagnosticError.niche}). Revisa el stack trace:\n${selectedDiagnosticError.stack || 'No stack trace available'}`;
                            try {
                              await navigator.clipboard.writeText(promptText);
                              showToast('Prompt copiado. ┬íP├®galo en el chat de Antigravity!', { type: 'success' });
                            } catch (err) {
                ...
                {/* Contexto Enriquecido de Telemetr├¡a (Environment & User) */}
                {selectedDiagnosticError.environment && (
                  <div className="space-y-3 bg-[var(--color-surface-2)]/60 border border-[var(--color-border)] p-4 rounded-2xl text-xs">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-[var(--color-text-muted)] font-mono text-[10px]">
                      <div>
                        <span className="font-extrabold text-[var(--color-text)] block">Resoluci├│n:</span>
                      ...
                      <div>
                        <span className="font-extrabold text-[var(--color-text)] block">P├ígina Activa:</span>
                        <a 
      ...
      {/* Modal de Simulaci├│n de Fallos Avanzado */}
            ...
            <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-[var(--color-text)] flex items-center gap-2">
                  <Activity size={16} className="text-violet-400 animate-pulse" />
                  Simulador de Fallos Telemetr├¡a (Sandbox)
                </h3>
            ...
            <div className="p-6 space-y-4 overflow-y-auto scrollbar-thin text-xs text-left">
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="1">FirebaseError (Servicio temporalmente ca├¡do) - Base de Datos</option>
                  ...
                  <option value="4">PaymentGatewayError (Timeout) - Cobros/Monetizaci├│n</option>
                  <option value="custom">-- Error Personalizado --</option>
                </select>
              </div>

              {/* Campos de texto din├ímicos */}
              ...
              <div className="grid grid-cols-2 gap-4 pt-1">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex gap-1 p-0.5 bg-slate-950 rounded-xl border border-slate-800">
                    {[
                      { id: 'automatic', label: 'Autom├ítico' },
      ...
      {/* Modal de Sincronizaci├│n Inteligente Lote (Bulk Sync) */}
      {isBulkSyncModalOpen && (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          ...
          <div className="w-full max-w-lg bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 flex flex-col max-h-[85vh] overflow-hidden">
            ...
            <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-[var(--color-text)] flex items-center gap-2">
                  ...
                  Sincronizaci├│n Inteligente Lote
                </h3>
                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Sincroniza m├║ltiples archivos desviados a la vez filtrando elementos sensibles.</p>
              </div>
              <button 
            ...
            <div className="p-6 space-y-4 overflow-y-auto scrollbar-thin text-xs text-left">
              ...
              <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl space-y-1 text-[10px] text-amber-400">
                <p className="font-bold flex items-center gap-1.5">
                  ÔÜá´©Å Filtro de Seguridad Inteligente Activo
                </p>
                      ...
                      >
                        ...
                        <div className="space-y-0.5">
                          ...
                          <span className="block text-[9px] font-bold">
                            {isSensitive ? (
                              <span className="text-amber-400">ÔÜá´©Å Archivo Sensible (Branding/Config)</span>
                            ) : (
                              <span className="text-indigo-400">Ô£ö L├│gica Core (Seguro para actualizar)</span>
                            )}
                          </span>
                        </div>
                      </label>
            ...
            <div className="p-6 border-t border-slate-800/85 bg-slate-950/20 flex items-center justify-end gap-3">
              ...
              >
                ...
                Aplicar Sincronizaci├│n ({Object.values(bulkSyncFiles).filter(Boolean).length})
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          ...
          <div className="w-full max-w-xl bg-slate-950 border border-slate-800 rounded-3xl shadow-2xl relative z-10 flex flex-col h-[70vh] overflow-hidden">
            ...
            <div className="flex-1 p-5 overflow-y-auto bg-slate-950 font-mono text-[10px] text-slate-350 space-y-1.5 scrollbar-thin text-left select-text">
              {deployLogs.map((log, index) => (
                <div key={index} className={`leading-relaxed whitespace-pre-wrap ${
                  log.startsWith('ÔØî') ? 'text-red-400 font-bold' : 
                  log.startsWith('ÔÜá') ? 'text-amber-400' : 
                  log.startsWith('Ô£à') || log.startsWith('­ƒÄë') ? 'text-emerald-400 font-bold' : 
                  log.startsWith('­ƒÜÇ') || log.startsWith('­ƒôª') ? 'text-indigo-400 font-bold' : 'text-slate-300'
                }`}>
                  {log}
                </div>
              ))}
            ...
            <div className="p-4 bg-slate-900 border-t border-slate-800/80 space-y-3.5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center text-[10px] font-bold">
                  ...
                  <span className={deployState === 'success' ? 'text-emerald-400' : deployState === 'failed' ? 'text-red-400' : 'text-indigo-400'}>
                    {deployState === 'success' ? 'Ô£ö COMPLETO' : deployState === 'failed' ? 'ÔØî FALLIDO' : `${deployProgressPercent}%`}
                  </span>
                </div>
              ...
              {/* Botones de acci├│n del terminal */}
              <div className="flex items-center justify-between text-xs pt-1">
                ...
                <div className="flex gap-2">
                  ...
                  {deployState === 'failed' && (
                    ...
                    >
                      Forzar Despliegue (Ignorar Auditor├¡a)
                    </button>
                  )}
                  <button
                    onClick={() => setIsDeployTerminalOpen(false)}
      ...
      {/* Modal de Configuraci├│n de Sincronizaci├│n Global */}
        ...
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/80 backdrop-blur-md animate-fade-in p-4">
          ...
          <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 flex flex-col max-h-[80vh] overflow-hidden">
            ...
            <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-[var(--color-text)] flex items-center gap-2">
                  ...
                  Sincronizaci├│n Global Core (Safe)
                </h3>
                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Selecciona los clientes en los que deseas sincronizar la l├│gica de archivos core.</p>
              </div>
              <button 
                ...
                {clientesSaas.filter(c => !c.archived).map(client => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <span className="block text-[9px] text-slate-400 font-medium">Nicho: {client.niche || 'N/A'} ÔÇó Versi├│n: Ecosistema Core</span>
                    </div>
                  </label>
                ))}
              </div>
            ...
            <div className="p-6 border-t border-slate-800/85 bg-slate-950/20 flex items-center justify-end gap-3">
              ...
              >
                Iniciar Sincronizaci├│n ({Object.values(globalSyncCheckedClients).filter(Boolean).length})
              </button>
            </div>
          </div>
        </div>
      ...
      {/* Modal de Configuraci├│n de Despliegue Global Hosting */}
          ...
          <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 flex flex-col max-h-[80vh] overflow-hidden">
            ...
            <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Selecciona los clientes cuyos proyectos de hosting de Firebase se compilar├ín y subir├ín.</p>
              </div>
              <button 
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                {clientesSaas.filter(c => !c.archived).map(client => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-slate-200">{client.id}</span>
                      <span className="block text-[9px] text-slate-400 font-medium">Nicho: {client.niche || 'N/A'} ÔÇó Hosting: Firebase</span>
                    </div>
                  </label>
                ))}
              </div>
      ...
      {/* Modal de Configuraci├│n de Telemetr├¡a Global */}
            ...
            <div className="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-black text-[var(--color-text)] flex items-center gap-2">
                  ...
                  Obtener Telemetr├¡a Global
                </h3>
                <p className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Selecciona los clientes a los que deseas solicitar un reporte de telemetr├¡a y diagn├│stico inmediato.</p>
              </div>
              <button 
              ...
              <div className="space-y-2 max-h-[40vh] overflow-y-auto pr-1">
                {clientesSaas.filter(c => !c.archived).map(client => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <span className="font-bold text-slate-200">{client.id}</span>
                      <span className="block text-[9px] text-slate-400 font-medium">Nicho: {client.niche || 'N/A'} ÔÇó Control de Telemetr├¡a</span>
                    </div>
                  </label>
                ))}
              </div>
